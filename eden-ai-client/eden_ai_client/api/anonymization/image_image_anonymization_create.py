...
from ...models.imageanonymization_response_model import ImageanonymizationResponseModel
...
) -> Optional[Union[BadRequest, Error, ImageanonymizationResponseModel, NotFoundResponse]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ImageanonymizationResponseModel.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[BadRequest, Error, ImageanonymizationResponseModel, NotFoundResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[BadRequest, Error, ImageanonymizationResponseModel, NotFoundResponse]
    """
