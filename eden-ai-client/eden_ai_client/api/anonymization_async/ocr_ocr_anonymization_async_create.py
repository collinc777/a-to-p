...
from ...models.anonymization_async_request import AnonymizationAsyncRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/ocr/anonymization_async",
    }

    if isinstance(body, AnonymizationAsyncRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (AnonymizationAsyncRequest):
        body (AnonymizationAsyncRequest):
