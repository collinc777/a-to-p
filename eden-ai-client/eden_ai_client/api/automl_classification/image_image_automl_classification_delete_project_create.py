...
from ...models.imageautoml_classificationdelete_project_automl_classification_delete_request import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/automl_classification/delete_project",
    }

    if isinstance(body, ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest):
        body (ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest):
