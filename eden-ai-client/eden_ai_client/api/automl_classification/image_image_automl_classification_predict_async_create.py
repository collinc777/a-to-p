...
from ...models.automl_classification_predict_request import AutomlClassificationPredictRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/automl_classification/predict_async",
    }

    if isinstance(body, AutomlClassificationPredictRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (AutomlClassificationPredictRequest):
        body (AutomlClassificationPredictRequest):
