...
from ...models.automl_classification_train_request import AutomlClassificationTrainRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/automl_classification/train_async",
    }

    if isinstance(body, AutomlClassificationTrainRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (AutomlClassificationTrainRequest):
        body (AutomlClassificationTrainRequest):
