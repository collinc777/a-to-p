...
from ...models.ocrbank_check_parsing_bank_check_parsing_request import OcrbankCheckParsingBankCheckParsingRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/ocr/bank_check_parsing",
    }

    if isinstance(body, OcrbankCheckParsingBankCheckParsingRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (OcrbankCheckParsingBankCheckParsingRequest):
        body (OcrbankCheckParsingBankCheckParsingRequest):
