...
from ...models.custom_document_parsing_async_request import CustomDocumentParsingAsyncRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/ocr/custom_document_parsing_async",
    }

    if isinstance(body, CustomDocumentParsingAsyncRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (CustomDocumentParsingAsyncRequest):
        body (CustomDocumentParsingAsyncRequest):
