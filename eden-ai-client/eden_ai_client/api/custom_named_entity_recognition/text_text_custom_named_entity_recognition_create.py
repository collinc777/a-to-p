...
from ...models.textcustom_named_entity_recognition_custom_named_entity_recognition_request import (
...
def _get_kwargs(
    *,
    body: TextcustomNamedEntityRecognitionCustomNamedEntityRecognitionRequest,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/text/custom_named_entity_recognition",
    }
