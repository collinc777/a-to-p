...
from ...models.textentity_sentiment_entity_sentiment_request import TextentitySentimentEntitySentimentRequest
from ...types import Response


def _get_kwargs(
    *,
    body: TextentitySentimentEntitySentimentRequest,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/text/entity_sentiment",
    }
