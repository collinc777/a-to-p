...
from ...models.imageface_compare_face_compare_request import ImagefaceCompareFaceCompareRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/face_compare",
    }

    if isinstance(body, ImagefaceCompareFaceCompareRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImagefaceCompareFaceCompareRequest):
        body (ImagefaceCompareFaceCompareRequest):
