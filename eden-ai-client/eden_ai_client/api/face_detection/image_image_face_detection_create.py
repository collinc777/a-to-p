...
from ...models.imageface_detection_face_detection_request import ImagefaceDetectionFaceDetectionRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/face_detection",
    }

    if isinstance(body, ImagefaceDetectionFaceDetectionRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImagefaceDetectionFaceDetectionRequest):
        body (ImagefaceDetectionFaceDetectionRequest):
