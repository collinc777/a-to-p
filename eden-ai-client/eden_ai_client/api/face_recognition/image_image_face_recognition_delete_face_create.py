...
from ...models.imageface_recognitiondelete_face_face_recognition_delete_face_request import (
...
def _get_kwargs(
    *,
    body: ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/face_recognition/delete_face",
    }
