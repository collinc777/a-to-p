...
from ...models.textquestion_answer_question_answer_request import TextquestionAnswerQuestionAnswerRequest
from ...types import Response


def _get_kwargs(
    *,
    body: TextquestionAnswerQuestionAnswerRequest,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/text/question_answer",
    }
