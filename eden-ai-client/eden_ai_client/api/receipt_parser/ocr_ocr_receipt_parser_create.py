...
from ...models.ocrreceipt_parser_receipt_parser_request import OcrreceiptParserReceiptParserRequest
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, OcrreceiptParserReceiptParserRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (OcrreceiptParserReceiptParserRequest):
        body (OcrreceiptParserReceiptParserRequest):
