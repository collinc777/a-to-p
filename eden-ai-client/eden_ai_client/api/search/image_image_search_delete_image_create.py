...
from ...models.imagesearchdelete_image_delete_image_request import ImagesearchdeleteImageDeleteImageRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/search/delete_image",
    }

    if isinstance(body, ImagesearchdeleteImageDeleteImageRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImagesearchdeleteImageDeleteImageRequest):
        body (ImagesearchdeleteImageDeleteImageRequest):
