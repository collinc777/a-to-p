...
from ...models.imagesearchlaunch_similarity_search_image_request import ImagesearchlaunchSimilaritySearchImageRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/search/launch_similarity",
    }

    if isinstance(body, ImagesearchlaunchSimilaritySearchImageRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImagesearchlaunchSimilaritySearchImageRequest):
        body (ImagesearchlaunchSimilaritySearchImageRequest):
