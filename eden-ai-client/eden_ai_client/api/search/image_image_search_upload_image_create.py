...
from ...models.imagesearchupload_image_upload_image_request import ImagesearchuploadImageUploadImageRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/image/search/upload_image",
    }

    if isinstance(body, ImagesearchuploadImageUploadImageRequest):
...
def sync_detailed(
    *,
    ...
    Args:
        body (ImagesearchuploadImageUploadImageRequest):
        body (ImagesearchuploadImageUploadImageRequest):
