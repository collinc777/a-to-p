...
if TYPE_CHECKING:
    from ..models.anonymization_async_request_users_webhook_parameters import (
        AnonymizationAsyncRequestUsersWebhookParameters,
    )


T = TypeVar("T", bound="AnonymizationAsyncRequest")


@_attrs_define
class AnonymizationAsyncRequest:
    """
    Attributes:
        ...
        users_webhook_parameters (Union[Unset, AnonymizationAsyncRequestUsersWebhookParameters]): Json data that
    ...
    users_webhook_parameters: Union[Unset, "AnonymizationAsyncRequestUsersWebhookParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_webhook_parameters: Union[Unset, AnonymizationAsyncRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = AnonymizationAsyncRequestUsersWebhookParameters.from_dict(
        ...
        anonymization_async_request = cls(
            providers=providers,
        ...
        anonymization_async_request.additional_properties = d
        return anonymization_async_request
