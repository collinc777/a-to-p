...
if TYPE_CHECKING:
    from ..models.async_ocr_request_users_webhook_parameters import AsyncOcrRequestUsersWebhookParameters


T = TypeVar("T", bound="AsyncOcrRequest")


@_attrs_define
class AsyncOcrRequest:
    """
    Attributes:
        ...
        users_webhook_parameters (Union[Unset, AsyncOcrRequestUsersWebhookParameters]): Json data that contains of
    ...
    users_webhook_parameters: Union[Unset, "AsyncOcrRequestUsersWebhookParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_webhook_parameters: Union[Unset, AsyncOcrRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = AsyncOcrRequestUsersWebhookParameters.from_dict(_users_webhook_parameters)
        ...
        async_ocr_request.additional_properties = d
        return async_ocr_request
