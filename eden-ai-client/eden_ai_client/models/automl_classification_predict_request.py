...
if TYPE_CHECKING:
    from ..models.automl_classification_predict_request_users_webhook_parameters import (
        AutomlClassificationPredictRequestUsersWebhookParameters,
    )


T = TypeVar("T", bound="AutomlClassificationPredictRequest")


@_attrs_define
class AutomlClassificationPredictRequest:
    """
    Attributes:
        ...
        users_webhook_parameters (Union[Unset, AutomlClassificationPredictRequestUsersWebhookParameters]): Json data
    ...
    users_webhook_parameters: Union[Unset, "AutomlClassificationPredictRequestUsersWebhookParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_webhook_parameters: Union[Unset, AutomlClassificationPredictRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = AutomlClassificationPredictRequestUsersWebhookParameters.from_dict(
        ...
        automl_classification_predict_request = cls(
            providers=providers,
            project_id=project_id,
        ...
        automl_classification_predict_request.additional_properties = d
        return automl_classification_predict_request
