...
from ..models.type_of_data_enum import TypeOfDataEnum
from ..types import UNSET, File, FileJsonType, Unset

if TYPE_CHECKING:
    from ..models.automl_classification_upload_data_request_users_webhook_parameters import (
        AutomlClassificationUploadDataRequestUsersWebhookParameters,
    )


T = TypeVar("T", bound="AutomlClassificationUploadDataRequest")


@_attrs_define
class AutomlClassificationUploadDataRequest:
    """
    Attributes:
        ...
        type_of_data (TypeOfDataEnum): * `TRAINING` - TRAINING
            * `TEST` - TEST
        ...
        users_webhook_parameters (Union[Unset, AutomlClassificationUploadDataRequestUsersWebhookParameters]): Json data
            that contains of additional parameters that will be sent back to the webhook receiver             (ex: api key
            for security or client's data ID to link the result internally).             Will only be used when
    ...
    users_webhook_parameters: Union[Unset, "AutomlClassificationUploadDataRequestUsersWebhookParameters"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        type_of_data = self.type_of_data.value
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        type_of_data = (None, str(self.type_of_data.value).encode(), "text/plain")
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type_of_data = TypeOfDataEnum(d.pop("type_of_data"))
        ...
        users_webhook_parameters: Union[Unset, AutomlClassificationUploadDataRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = AutomlClassificationUploadDataRequestUsersWebhookParameters.from_dict(
        ...
        automl_classification_upload_data_request = cls(
            providers=providers,
            project_id=project_id,
            label=label,
            type_of_data=type_of_data,
        ...
        automl_classification_upload_data_request.additional_properties = d
        return automl_classification_upload_data_request
