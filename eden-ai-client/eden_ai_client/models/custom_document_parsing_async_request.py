...
if TYPE_CHECKING:
    from ..models.custom_document_parsing_async_request_users_webhook_parameters import (
        CustomDocumentParsingAsyncRequestUsersWebhookParameters,
    )


T = TypeVar("T", bound="CustomDocumentParsingAsyncRequest")


@_attrs_define
class CustomDocumentParsingAsyncRequest:
    """
    Attributes:
        providers (str): It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex:
            **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed
            results.
        queries (str): Your queries need to be a list of dict containing the questions you want answered and the page to
            look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your
            pages'}]'
        ...
        users_webhook_parameters (Union[Unset, CustomDocumentParsingAsyncRequestUsersWebhookParameters]): Json data that
    ...
    users_webhook_parameters: Union[Unset, "CustomDocumentParsingAsyncRequestUsersWebhookParameters"] = UNSET
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        queries = self.queries if isinstance(self.queries, Unset) else (None, str(self.queries).encode(), "text/plain")
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        users_webhook_parameters: Union[Unset, CustomDocumentParsingAsyncRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = CustomDocumentParsingAsyncRequestUsersWebhookParameters.from_dict(
        ...
        custom_document_parsing_async_request = cls(
            providers=providers,
            queries=queries,
        ...
        custom_document_parsing_async_request.additional_properties = d
        return custom_document_parsing_async_request
