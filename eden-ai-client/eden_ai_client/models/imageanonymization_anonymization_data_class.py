...
if TYPE_CHECKING:
    from ..models.anonymization_item import AnonymizationItem


T = TypeVar("T", bound="ImageanonymizationAnonymizationDataClass")


@_attrs_define
class ImageanonymizationAnonymizationDataClass:
    """
    Attributes:
        image (str):
        image_resource_url (str):
        status (StatusF43Enum):
        items (Union[Unset, List['AnonymizationItem']]):
    ...
    image_resource_url: str
    status: StatusF43Enum
    items: Union[Unset, List["AnonymizationItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = AnonymizationItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        imageanonymization_anonymization_data_class = cls(
            image=image,
            image_resource_url=image_resource_url,
            status=status,
            items=items,
        ...
        imageanonymization_anonymization_data_class.additional_properties = d
        return imageanonymization_anonymization_data_class
