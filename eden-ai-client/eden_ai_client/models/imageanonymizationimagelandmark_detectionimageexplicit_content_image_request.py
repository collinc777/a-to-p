...
T = TypeVar("T", bound="ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest")


@_attrs_define
class ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request = cls(
            providers=providers,
        ...
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request.additional_properties = d
        return imageanonymizationimagelandmark_detectionimageexplicit_content_image_request
