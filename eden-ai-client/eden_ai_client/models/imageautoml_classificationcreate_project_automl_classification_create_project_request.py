...
T = TypeVar("T", bound="ImageautomlClassificationcreateProjectAutomlClassificationCreateProjectRequest")


@_attrs_define
class ImageautomlClassificationcreateProjectAutomlClassificationCreateProjectRequest:
    """
    Attributes:
        ...
        show_original_response (Union[Unset, bool]): Optional : Shows the original response of the provider.<br>
            ...
            False.
        name (Union[Unset, str]): Name of your project
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageautoml_classificationcreate_project_automl_classification_create_project_request = cls(
            providers=providers,
        ...
        imageautoml_classificationcreate_project_automl_classification_create_project_request.additional_properties = d
        return imageautoml_classificationcreate_project_automl_classification_create_project_request
