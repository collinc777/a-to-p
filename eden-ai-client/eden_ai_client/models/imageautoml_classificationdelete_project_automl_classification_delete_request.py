...
T = TypeVar("T", bound="ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest")


@_attrs_define
class ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageautoml_classificationdelete_project_automl_classification_delete_request = cls(
            providers=providers,
            project_id=project_id,
        ...
        imageautoml_classificationdelete_project_automl_classification_delete_request.additional_properties = d
        return imageautoml_classificationdelete_project_automl_classification_delete_request
