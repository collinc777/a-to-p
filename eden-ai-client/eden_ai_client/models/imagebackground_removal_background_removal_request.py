...
T = TypeVar("T", bound="ImagebackgroundRemovalBackgroundRemovalRequest")


@_attrs_define
class ImagebackgroundRemovalBackgroundRemovalRequest:
    """
    Attributes:
        ...
        file_url (Union[None, Unset, str]): File **URL** to analyse to be used with with *content-type*:
            **application/json**.
        provider_params (Union[Unset, str]): Provider specific parameters Default: '{}'.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagebackground_removal_background_removal_request = cls(
            providers=providers,
        ...
        imagebackground_removal_background_removal_request.additional_properties = d
        return imagebackground_removal_background_removal_request
