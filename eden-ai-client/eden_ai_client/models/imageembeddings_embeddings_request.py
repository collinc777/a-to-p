...
from ..models.representation_enum import RepresentationEnum
from ..types import UNSET, File, FileJsonType, Unset

T = TypeVar("T", bound="ImageembeddingsEmbeddingsRequest")


@_attrs_define
class ImageembeddingsEmbeddingsRequest:
    """
    Attributes:
        providers (str): It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex:
            **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed
            results.
        representation (RepresentationEnum): * `document` - document
            * `query` - query
            * `symetric` - symetric
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        representation = (None, str(self.representation.value).encode(), "text/plain")
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        representation = RepresentationEnum(d.pop("representation"))
        ...
        imageembeddings_embeddings_request = cls(
            providers=providers,
            representation=representation,
        ...
        imageembeddings_embeddings_request.additional_properties = d
        return imageembeddings_embeddings_request
