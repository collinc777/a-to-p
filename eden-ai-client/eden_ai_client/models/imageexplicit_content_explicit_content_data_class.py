...
if TYPE_CHECKING:
    from ..models.explicit_item import ExplicitItem


T = TypeVar("T", bound="ImageexplicitContentExplicitContentDataClass")


@_attrs_define
class ImageexplicitContentExplicitContentDataClass:
    """
    Attributes:
        nsfw_likelihood (int):
        nsfw_likelihood_score (int):
        status (StatusF43Enum):
        items (Union[Unset, List['ExplicitItem']]):
    ...
    nsfw_likelihood_score: int
    status: StatusF43Enum
    items: Union[Unset, List["ExplicitItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = ExplicitItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        imageexplicit_content_explicit_content_data_class = cls(
            nsfw_likelihood=nsfw_likelihood,
            nsfw_likelihood_score=nsfw_likelihood_score,
            status=status,
            items=items,
        ...
        imageexplicit_content_explicit_content_data_class.additional_properties = d
        return imageexplicit_content_explicit_content_data_class
