...
T = TypeVar("T", bound="ImagefaceCompareFaceCompareDataClass")


@_attrs_define
class ImagefaceCompareFaceCompareDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        items (Union[Unset, List['FaceMatch']]):
    ...
    status: StatusF43Enum
    items: Union[Unset, List["FaceMatch"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = FaceMatch.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        imageface_compare_face_compare_data_class = cls(
            status=status,
            items=items,
            original_response=original_response,
        )

        imageface_compare_face_compare_data_class.additional_properties = d
        return imageface_compare_face_compare_data_class
