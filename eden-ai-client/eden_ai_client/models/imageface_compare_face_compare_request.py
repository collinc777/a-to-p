...
T = TypeVar("T", bound="ImagefaceCompareFaceCompareRequest")


@_attrs_define
class ImagefaceCompareFaceCompareRequest:
    """
    Attributes:
        ...
        show_original_response (Union[Unset, bool]): Optional : Shows the original response of the provider.<br>
            ...
            False.
        file1 (Union[Unset, File]): File to analyse in binary format to be used with *content-type*: **multipart/form-
            data** <br> **Does not work with application/json !**
        file1_url (Union[None, Unset, str]): File **URL** to analyse to be used with with *content-type*:
            **application/json**.
        file2 (Union[Unset, File]): File to analyse in binary format to be used with *content-type*: **multipart/form-
            data** <br> **Does not work with application/json !**
        file2_url (Union[None, Unset, str]): File **URL** to analyse to be used with with *content-type*:
            **application/json**.
    """
    ...
    file1_url: Union[None, Unset, str] = UNSET
    file2: Union[Unset, File] = UNSET
    file2_url: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        file1_url: Union[None, Unset, str]
        if isinstance(self.file1_url, Unset):
            file1_url = UNSET
        else:
        ...
        file2_url: Union[None, Unset, str]
        if isinstance(self.file2_url, Unset):
            file2_url = UNSET
        else:
        ...
        if file1_url is not UNSET:
            field_dict["file1_url"] = file1_url
        if file2 is not UNSET:
            field_dict["file2"] = file2
        if file2_url is not UNSET:
            field_dict["file2_url"] = file2_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_file1_url(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        file1_url = _parse_file1_url(d.pop("file1_url", UNSET))
        ...
        def _parse_file2_url(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        file2_url = _parse_file2_url(d.pop("file2_url", UNSET))

        imageface_compare_face_compare_request = cls(
            providers=providers,
        ...
        imageface_compare_face_compare_request.additional_properties = d
        return imageface_compare_face_compare_request
