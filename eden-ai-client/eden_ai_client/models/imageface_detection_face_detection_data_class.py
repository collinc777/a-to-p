...
if TYPE_CHECKING:
    from ..models.face_item import FaceItem


T = TypeVar("T", bound="ImagefaceDetectionFaceDetectionDataClass")


@_attrs_define
class ImagefaceDetectionFaceDetectionDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        items (Union[Unset, List['FaceItem']]):
    ...
    status: StatusF43Enum
    items: Union[Unset, List["FaceItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = FaceItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        imageface_detection_face_detection_data_class = cls(
            status=status,
            items=items,
            original_response=original_response,
        )

        imageface_detection_face_detection_data_class.additional_properties = d
        return imageface_detection_face_detection_data_class
