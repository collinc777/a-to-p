...
T = TypeVar("T", bound="ImagefaceDetectionFaceDetectionRequest")


@_attrs_define
class ImagefaceDetectionFaceDetectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageface_detection_face_detection_request = cls(
            providers=providers,
        ...
        imageface_detection_face_detection_request.additional_properties = d
        return imageface_detection_face_detection_request
