...
T = TypeVar("T", bound="ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest")


@_attrs_define
class ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageface_recognitiondelete_face_face_recognition_delete_face_request = cls(
            providers=providers,
            face_id=face_id,
        ...
        imageface_recognitiondelete_face_face_recognition_delete_face_request.additional_properties = d
        return imageface_recognitiondelete_face_face_recognition_delete_face_request
