...
if TYPE_CHECKING:
    from ..models.logo_item import LogoItem


T = TypeVar("T", bound="ImagelogoDetectionLogoDetectionDataClass")


@_attrs_define
class ImagelogoDetectionLogoDetectionDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        items (Union[Unset, List['LogoItem']]):
    ...
    status: StatusF43Enum
    items: Union[Unset, List["LogoItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = LogoItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        imagelogo_detection_logo_detection_data_class = cls(
            status=status,
            items=items,
            original_response=original_response,
        )

        imagelogo_detection_logo_detection_data_class.additional_properties = d
        return imagelogo_detection_logo_detection_data_class
