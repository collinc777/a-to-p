...
T = TypeVar("T", bound="ImagelogoDetectionLogoDetectionRequest")


@_attrs_define
class ImagelogoDetectionLogoDetectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagelogo_detection_logo_detection_request = cls(
            providers=providers,
        ...
        imagelogo_detection_logo_detection_request.additional_properties = d
        return imagelogo_detection_logo_detection_request
