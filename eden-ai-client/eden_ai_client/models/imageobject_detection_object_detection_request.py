...
T = TypeVar("T", bound="ImageobjectDetectionObjectDetectionRequest")


@_attrs_define
class ImageobjectDetectionObjectDetectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imageobject_detection_object_detection_request = cls(
            providers=providers,
        ...
        imageobject_detection_object_detection_request.additional_properties = d
        return imageobject_detection_object_detection_request
