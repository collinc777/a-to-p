...
T = TypeVar("T", bound="ImagequestionAnswerQuestionAnswerDataClass")


@_attrs_define
class ImagequestionAnswerQuestionAnswerDataClass:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagequestion_answer_question_answer_data_class = cls(
            status=status,
            answers=answers,
            original_response=original_response,
        )

        imagequestion_answer_question_answer_data_class.additional_properties = d
        return imagequestion_answer_question_answer_data_class
