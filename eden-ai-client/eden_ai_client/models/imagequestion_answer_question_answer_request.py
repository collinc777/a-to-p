...
T = TypeVar("T", bound="ImagequestionAnswerQuestionAnswerRequest")


@_attrs_define
class ImagequestionAnswerQuestionAnswerRequest:
    """
    Attributes:
        ...
        question (Union[Unset, str]): Question about the image
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        max_tokens = (
            ...
            else (None, str(self.max_tokens).encode(), "text/plain")
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagequestion_answer_question_answer_request = cls(
            providers=providers,
        ...
        imagequestion_answer_question_answer_request.additional_properties = d
        return imagequestion_answer_question_answer_request
