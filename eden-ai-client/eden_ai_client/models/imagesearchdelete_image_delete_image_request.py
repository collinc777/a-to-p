...
T = TypeVar("T", bound="ImagesearchdeleteImageDeleteImageRequest")


@_attrs_define
class ImagesearchdeleteImageDeleteImageRequest:
    """
    Attributes:
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        image_name = (
            ...
            else (None, str(self.image_name).encode(), "text/plain")
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagesearchdelete_image_delete_image_request = cls(
            providers=providers,
            image_name=image_name,
        ...
        imagesearchdelete_image_delete_image_request.additional_properties = d
        return imagesearchdelete_image_delete_image_request
