...
T = TypeVar("T", bound="ImagesearchlaunchSimilaritySearchImageRequest")


@_attrs_define
class ImagesearchlaunchSimilaritySearchImageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        imagesearchlaunch_similarity_search_image_request = cls(
            providers=providers,
        ...
        imagesearchlaunch_similarity_search_image_request.additional_properties = d
        return imagesearchlaunch_similarity_search_image_request
