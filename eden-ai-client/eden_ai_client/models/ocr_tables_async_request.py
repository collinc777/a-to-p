...
if TYPE_CHECKING:
    from ..models.ocr_tables_async_request_users_webhook_parameters import OcrTablesAsyncRequestUsersWebhookParameters


T = TypeVar("T", bound="OcrTablesAsyncRequest")


@_attrs_define
class OcrTablesAsyncRequest:
    """
    Attributes:
        ...
        users_webhook_parameters (Union[Unset, OcrTablesAsyncRequestUsersWebhookParameters]): Json data that contains of
            additional parameters that will be sent back to the webhook receiver             (ex: api key for security or
    ...
    users_webhook_parameters: Union[Unset, "OcrTablesAsyncRequestUsersWebhookParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.ocr_tables_async_request_users_webhook_parameters import (
        ...
        users_webhook_parameters: Union[Unset, OcrTablesAsyncRequestUsersWebhookParameters]
        if isinstance(_users_webhook_parameters, Unset):
            users_webhook_parameters = UNSET
        else:
            users_webhook_parameters = OcrTablesAsyncRequestUsersWebhookParameters.from_dict(_users_webhook_parameters)
        ...
        ocr_tables_async_request.additional_properties = d
        return ocr_tables_async_request
