...
if TYPE_CHECKING:
    from ..models.item_bank_check_parsing_data_class import ItemBankCheckParsingDataClass


T = TypeVar("T", bound="OcrbankCheckParsingBankCheckParsingDataClass")


@_attrs_define
class OcrbankCheckParsingBankCheckParsingDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        extracted_data (Union[Unset, List['ItemBankCheckParsingDataClass']]):
    ...
    status: StatusF43Enum
    extracted_data: Union[Unset, List["ItemBankCheckParsingDataClass"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for extracted_data_item_data in _extracted_data or []:
            extracted_data_item = ItemBankCheckParsingDataClass.from_dict(extracted_data_item_data)

            extracted_data.append(extracted_data_item)

        original_response = d.pop("original_response", UNSET)

        ocrbank_check_parsing_bank_check_parsing_data_class = cls(
            status=status,
            extracted_data=extracted_data,
            original_response=original_response,
        )

        ocrbank_check_parsing_bank_check_parsing_data_class.additional_properties = d
        return ocrbank_check_parsing_bank_check_parsing_data_class
