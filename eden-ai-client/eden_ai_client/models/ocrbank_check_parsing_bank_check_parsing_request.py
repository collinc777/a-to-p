...
T = TypeVar("T", bound="OcrbankCheckParsingBankCheckParsingRequest")


@_attrs_define
class OcrbankCheckParsingBankCheckParsingRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocrbank_check_parsing_bank_check_parsing_request = cls(
            providers=providers,
        ...
        ocrbank_check_parsing_bank_check_parsing_request.additional_properties = d
        return ocrbank_check_parsing_bank_check_parsing_request
