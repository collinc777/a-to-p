...
T = TypeVar("T", bound="OcrdataExtractionDataExtractionRequest")


@_attrs_define
class OcrdataExtractionDataExtractionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocrdata_extraction_data_extraction_request = cls(
            providers=providers,
        ...
        ocrdata_extraction_data_extraction_request.additional_properties = d
        return ocrdata_extraction_data_extraction_request
