...
if TYPE_CHECKING:
    from ..models.financial_parser_object_data_class import FinancialParserObjectDataClass


T = TypeVar("T", bound="OcrfinancialParserFinancialParserDataClass")


@_attrs_define
class OcrfinancialParserFinancialParserDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        extracted_data (Union[Unset, List['FinancialParserObjectDataClass']]): List of parsed financial data objects
            (per page).
    ...
    status: StatusF43Enum
    extracted_data: Union[Unset, List["FinancialParserObjectDataClass"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for extracted_data_item_data in _extracted_data or []:
            extracted_data_item = FinancialParserObjectDataClass.from_dict(extracted_data_item_data)

            extracted_data.append(extracted_data_item)

        original_response = d.pop("original_response", UNSET)

        ocrfinancial_parser_financial_parser_data_class = cls(
            status=status,
            extracted_data=extracted_data,
            original_response=original_response,
        )

        ocrfinancial_parser_financial_parser_data_class.additional_properties = d
        return ocrfinancial_parser_financial_parser_data_class
