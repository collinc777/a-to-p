...
T = TypeVar("T", bound="OcridentityParserIdentityParserRequest")


@_attrs_define
class OcridentityParserIdentityParserRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocridentity_parser_identity_parser_request = cls(
            providers=providers,
        ...
        ocridentity_parser_identity_parser_request.additional_properties = d
        return ocridentity_parser_identity_parser_request
