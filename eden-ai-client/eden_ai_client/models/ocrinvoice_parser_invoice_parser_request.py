...
T = TypeVar("T", bound="OcrinvoiceParserInvoiceParserRequest")


@_attrs_define
class OcrinvoiceParserInvoiceParserRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocrinvoice_parser_invoice_parser_request = cls(
            providers=providers,
        ...
        ocrinvoice_parser_invoice_parser_request.additional_properties = d
        return ocrinvoice_parser_invoice_parser_request
