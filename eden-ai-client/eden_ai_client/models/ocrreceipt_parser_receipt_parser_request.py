...
T = TypeVar("T", bound="OcrreceiptParserReceiptParserRequest")


@_attrs_define
class OcrreceiptParserReceiptParserRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocrreceipt_parser_receipt_parser_request = cls(
            providers=providers,
        ...
        ocrreceipt_parser_receipt_parser_request.additional_properties = d
        return ocrreceipt_parser_receipt_parser_request
