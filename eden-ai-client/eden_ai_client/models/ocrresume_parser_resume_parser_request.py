...
T = TypeVar("T", bound="OcrresumeParserResumeParserRequest")


@_attrs_define
class OcrresumeParserResumeParserRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ocrresume_parser_resume_parser_request = cls(
            providers=providers,
        ...
        ocrresume_parser_resume_parser_request.additional_properties = d
        return ocrresume_parser_resume_parser_request
