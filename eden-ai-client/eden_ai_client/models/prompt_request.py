...
if TYPE_CHECKING:
    from ..models.prompt_request_params_type_0 import PromptRequestParamsType0
...
class PromptRequest:
    ...
    Attributes:
        ...
        params (Union['PromptRequestParamsType0', None, Unset]):
    """
    ...
    params: Union["PromptRequestParamsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.params, Unset):
            params = UNSET
        elif isinstance(self.params, PromptRequestParamsType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_params(data: object) -> Union["PromptRequestParamsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                params_type_0 = PromptRequestParamsType0.from_dict(data)

                return params_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PromptRequestParamsType0", None, Unset], data)
