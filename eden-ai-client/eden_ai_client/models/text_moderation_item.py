...
T = TypeVar("T", bound="TextModerationItem")


@_attrs_define
class TextModerationItem:
    """
    Attributes:
        label (str):
        likelihood (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        text_moderation_item.additional_properties = d
        return text_moderation_item
