...
if TYPE_CHECKING:
    from ..models.ai_detection_item import AiDetectionItem


T = TypeVar("T", bound="TextaiDetectionAiDetectionDataClass")


@_attrs_define
class TextaiDetectionAiDetectionDataClass:
    """
    Attributes:
        ai_score (int):
        status (StatusF43Enum):
        items (Union[Unset, List['AiDetectionItem']]):
    ...
    ai_score: int
    status: StatusF43Enum
    items: Union[Unset, List["AiDetectionItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = AiDetectionItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        textai_detection_ai_detection_data_class = cls(
            ai_score=ai_score,
            status=status,
            items=items,
        ...
        textai_detection_ai_detection_data_class.additional_properties = d
        return textai_detection_ai_detection_data_class
