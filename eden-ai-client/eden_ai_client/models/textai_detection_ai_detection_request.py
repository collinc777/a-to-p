...
T = TypeVar("T", bound="TextaiDetectionAiDetectionRequest")


@_attrs_define
class TextaiDetectionAiDetectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textai_detection_ai_detection_request = cls(
            providers=providers,
            text=text,
        ...
        textai_detection_ai_detection_request.additional_properties = d
        return textai_detection_ai_detection_request
