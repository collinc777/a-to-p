...
from ..models.fallback_type_enum import FallbackTypeEnum
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.textchat_chat_stream_request_previous_history_item import TextchatChatStreamRequestPreviousHistoryItem


T = TypeVar("T", bound="TextchatChatStreamRequest")


@_attrs_define
class TextchatChatStreamRequest:
    """
    Attributes:
        ...
        previous_history (Union[Unset, List['TextchatChatStreamRequestPreviousHistoryItem']]): A list containing all the
        ...
        fallback_type (Union[Unset, FallbackTypeEnum]): * `rerun` - Rerun
            * `continue` - Continue Default: FallbackTypeEnum.CONTINUE.
    """
    ...
    previous_history: Union[Unset, List["TextchatChatStreamRequestPreviousHistoryItem"]] = UNSET
    temperature: Union[Unset, float] = 0.0
    max_tokens: Union[Unset, int] = 1000
    fallback_type: Union[Unset, FallbackTypeEnum] = FallbackTypeEnum.CONTINUE
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        fallback_type: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.textchat_chat_stream_request_previous_history_item import (
        ...
        for previous_history_item_data in _previous_history or []:
            previous_history_item = TextchatChatStreamRequestPreviousHistoryItem.from_dict(previous_history_item_data)
        ...
        fallback_type: Union[Unset, FallbackTypeEnum]
        if isinstance(_fallback_type, Unset):
            fallback_type = UNSET
        else:
            fallback_type = FallbackTypeEnum(_fallback_type)

        textchat_chat_stream_request = cls(
            providers=providers,
        ...
        textchat_chat_stream_request.additional_properties = d
        return textchat_chat_stream_request
