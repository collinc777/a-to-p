...
T = TypeVar("T", bound="TextcodeGenerationCodeGenerationDataClass")


@_attrs_define
class TextcodeGenerationCodeGenerationDataClass:
    """
    Attributes:
        generated_text (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textcode_generation_code_generation_data_class = cls(
            generated_text=generated_text,
            status=status,
            original_response=original_response,
        )

        textcode_generation_code_generation_data_class.additional_properties = d
        return textcode_generation_code_generation_data_class
