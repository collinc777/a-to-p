...
T = TypeVar("T", bound="TextembeddingsEmbeddingsRequest")


@_attrs_define
class TextembeddingsEmbeddingsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textembeddings_embeddings_request = cls(
            providers=providers,
            texts=texts,
        ...
        textembeddings_embeddings_request.additional_properties = d
        return textembeddings_embeddings_request
