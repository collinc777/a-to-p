...
T = TypeVar("T", bound="TextemotionDetectionEmotionDetectionRequest")


@_attrs_define
class TextemotionDetectionEmotionDetectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textemotion_detection_emotion_detection_request = cls(
            providers=providers,
            text=text,
        ...
        textemotion_detection_emotion_detection_request.additional_properties = d
        return textemotion_detection_emotion_detection_request
