...
T = TypeVar("T", bound="TextentitySentimentEntitySentimentRequest")


@_attrs_define
class TextentitySentimentEntitySentimentRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textentity_sentiment_entity_sentiment_request = cls(
            providers=providers,
            text=text,
        ...
        textentity_sentiment_entity_sentiment_request.additional_properties = d
        return textentity_sentiment_entity_sentiment_request
