...
T = TypeVar("T", bound="TextplagiaDetectionPlagiaDetectionRequest")


@_attrs_define
class TextplagiaDetectionPlagiaDetectionRequest:
    """
    Attributes:
        ...
        show_original_response (Union[Unset, bool]): Optional : Shows the original response of the provider.<br>
            ...
            False.
        title (Union[None, Unset, str]): Content title Default: ''.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textplagia_detection_plagia_detection_request = cls(
            providers=providers,
            text=text,
        ...
        textplagia_detection_plagia_detection_request.additional_properties = d
        return textplagia_detection_plagia_detection_request
