...
from ..models.target_provider_enum import TargetProviderEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="TextpromptOptimizationPromptOptimizationRequest")


@_attrs_define
class TextpromptOptimizationPromptOptimizationRequest:
    """
    Attributes:
        ...
        target_provider (TargetProviderEnum): * `google` - google
            * `openai` - openai
            * `cohere` - cohere
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        target_provider = TargetProviderEnum(d.pop("target_provider"))
        ...
        textprompt_optimization_prompt_optimization_request = cls(
            providers=providers,
            text=text,
            target_provider=target_provider,
        ...
        textprompt_optimization_prompt_optimization_request.additional_properties = d
        return textprompt_optimization_prompt_optimization_request
