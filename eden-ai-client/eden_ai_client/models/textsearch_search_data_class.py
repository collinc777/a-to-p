...
if TYPE_CHECKING:
    from ..models.infos_search_data_class import InfosSearchDataClass


T = TypeVar("T", bound="TextsearchSearchDataClass")


@_attrs_define
class TextsearchSearchDataClass:
    """
    Attributes:
        status (StatusF43Enum):
        items (Union[Unset, List['InfosSearchDataClass']]):
    ...
    status: StatusF43Enum
    items: Union[Unset, List["InfosSearchDataClass"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = InfosSearchDataClass.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        textsearch_search_data_class = cls(
            status=status,
            items=items,
            original_response=original_response,
        )

        textsearch_search_data_class.additional_properties = d
        return textsearch_search_data_class
