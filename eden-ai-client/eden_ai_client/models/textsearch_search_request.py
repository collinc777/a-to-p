...
from ..models.similarity_metric_enum import SimilarityMetricEnum
from ..types import UNSET, Unset

T = TypeVar("T", bound="TextsearchSearchRequest")


@_attrs_define
class TextsearchSearchRequest:
    """
    Attributes:
        ...
        show_original_response (Union[Unset, bool]): Optional : Shows the original response of the provider.<br>
            ...
            False.
        similarity_metric (Union[Unset, SimilarityMetricEnum]): * `cosine` - cosine
            * `manhattan` - manhattan
            * `euclidean` - euclidean Default: SimilarityMetricEnum.COSINE.
    """
    ...
    similarity_metric: Union[Unset, SimilarityMetricEnum] = SimilarityMetricEnum.COSINE
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        similarity_metric: Union[Unset, str] = UNSET
        if not isinstance(self.similarity_metric, Unset):
        ...
        if similarity_metric is not UNSET:
            field_dict["similarity_metric"] = similarity_metric
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _similarity_metric = d.pop("similarity_metric", UNSET)
        similarity_metric: Union[Unset, SimilarityMetricEnum]
        if isinstance(_similarity_metric, Unset):
            similarity_metric = UNSET
        else:
            similarity_metric = SimilarityMetricEnum(_similarity_metric)

        textsearch_search_request = cls(
            providers=providers,
            texts=texts,
            query=query,
        ...
        textsearch_search_request.additional_properties = d
        return textsearch_search_request
