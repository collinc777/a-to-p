...
if TYPE_CHECKING:
    from ..models.spell_check_item import SpellCheckItem


T = TypeVar("T", bound="TextspellCheckSpellCheckDataClass")


@_attrs_define
class TextspellCheckSpellCheckDataClass:
    """
    Attributes:
        text (str):
        status (StatusF43Enum):
        items (Union[Unset, List['SpellCheckItem']]):
    ...
    text: str
    status: StatusF43Enum
    items: Union[Unset, List["SpellCheckItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = SpellCheckItem.from_dict(items_item_data)

            items.append(items_item)

        original_response = d.pop("original_response", UNSET)

        textspell_check_spell_check_data_class = cls(
            text=text,
            status=status,
            items=items,
        ...
        textspell_check_spell_check_data_class.additional_properties = d
        return textspell_check_spell_check_data_class
