...
T = TypeVar("T", bound="TextspellCheckSpellCheckRequest")


@_attrs_define
class TextspellCheckSpellCheckRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textspell_check_spell_check_request = cls(
            providers=providers,
            text=text,
        ...
        textspell_check_spell_check_request.additional_properties = d
        return textspell_check_spell_check_request
