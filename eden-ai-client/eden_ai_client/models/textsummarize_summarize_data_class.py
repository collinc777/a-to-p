...
T = TypeVar("T", bound="TextsummarizeSummarizeDataClass")


@_attrs_define
class TextsummarizeSummarizeDataClass:
    """
    Attributes:
        result (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        textsummarize_summarize_data_class = cls(
            result=result,
            status=status,
            original_response=original_response,
        )

        textsummarize_summarize_data_class.additional_properties = d
        return textsummarize_summarize_data_class
