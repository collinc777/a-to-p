...
T = TypeVar("T", bound="TextsummarizeSummarizeRequest")


@_attrs_define
class TextsummarizeSummarizeRequest:
    """
    Attributes:
        ...
        settings (Union[Unset, str]): A dictionnary or a json object to specify specific models to use for some
            ...
            "ibm_model"...}.
                                 **Caution**: setting models can be done only with `Content-Type` : `application/json`.
                                  Default: '{}'.
        output_sentences (Union[Unset, int]):  Default: 1.
    """
    ...
    output_sentences: Union[Unset, int] = 1
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        output_sentences = self.output_sentences
        ...
        if output_sentences is not UNSET:
            field_dict["output_sentences"] = output_sentences
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        output_sentences = d.pop("output_sentences", UNSET)

        textsummarize_summarize_request = cls(
            providers=providers,
            text=text,
        ...
        textsummarize_summarize_request.additional_properties = d
        return textsummarize_summarize_request
