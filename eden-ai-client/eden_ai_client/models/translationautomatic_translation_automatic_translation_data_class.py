...
T = TypeVar("T", bound="TranslationautomaticTranslationAutomaticTranslationDataClass")


@_attrs_define
class TranslationautomaticTranslationAutomaticTranslationDataClass:
    """
    Attributes:
        text (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        translationautomatic_translation_automatic_translation_data_class = cls(
            text=text,
            status=status,
            original_response=original_response,
        )

        translationautomatic_translation_automatic_translation_data_class.additional_properties = d
        return translationautomatic_translation_automatic_translation_data_class
