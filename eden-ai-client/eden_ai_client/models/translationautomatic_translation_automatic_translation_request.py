...
T = TypeVar("T", bound="TranslationautomaticTranslationAutomaticTranslationRequest")


@_attrs_define
class TranslationautomaticTranslationAutomaticTranslationRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        translationautomatic_translation_automatic_translation_request = cls(
            providers=providers,
            text=text,
            target_language=target_language,
        ...
        translationautomatic_translation_automatic_translation_request.additional_properties = d
        return translationautomatic_translation_automatic_translation_request
