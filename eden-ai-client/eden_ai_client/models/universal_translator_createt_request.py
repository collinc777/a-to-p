...
T = TypeVar("T", bound="UniversalTranslatorCreatetRequest")


@_attrs_define
class UniversalTranslatorCreatetRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        universal_translator_createt_request = cls(
            project_name=project_name,
            provider=provider,
        ...
        universal_translator_createt_request.additional_properties = d
        return universal_translator_createt_request
