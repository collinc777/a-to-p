# openapi_client.AnonymizationAsyncApi

All URIs are relative to *https://api.edenai.run/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**ocr_ocr_anonymization_async_create**](AnonymizationAsyncApi.md#ocr_ocr_anonymization_async_create) | **POST** /ocr/anonymization_async | Anonymization Launch Job
[**ocr_ocr_anonymization_async_destroy**](AnonymizationAsyncApi.md#ocr_ocr_anonymization_async_destroy) | **DELETE** /ocr/anonymization_async | Anonymization delete Jobs
[**ocr_ocr_anonymization_async_retrieve**](AnonymizationAsyncApi.md#ocr_ocr_anonymization_async_retrieve) | **GET** /ocr/anonymization_async | Anonymization List Job
[**ocr_ocr_anonymization_async_retrieve2**](AnonymizationAsyncApi.md#ocr_ocr_anonymization_async_retrieve2) | **GET** /ocr/anonymization_async/{public_id} | Anonymization Get Job Results


# **ocr_ocr_anonymization_async_create**
> LaunchAsyncJobResponse ocr_ocr_anonymization_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url, file_password=file_password)

Anonymization Launch Job

<details><summary><strong style='color: #0072a3; cursor: pointer'>Available Providers</strong></summary>    |Provider|Version|Price|Billing unit| |----|-------|-----|------------| |**readyredact**|`v1`|0.05 (per 1 file)|1 file |**base64**|`v1`|0.25 (per 1 page)|1 page |**privateai**|`v3`|0.01 (per 1 page)|1 page   </details>  
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.AnonymizationAsyncApi(api_client)
    ...
    try:
        # Anonymization Launch Job
        api_response = await api_instance.ocr_ocr_anonymization_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url, file_password=file_password)
        print("The response of AnonymizationAsyncApi->ocr_ocr_anonymization_async_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnonymizationAsyncApi->ocr_ocr_anonymization_async_create: %s\n" % e)
```
...
# **ocr_ocr_anonymization_async_destroy**
> ocr_ocr_anonymization_async_destroy()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Anonymization delete Jobs
        await api_instance.ocr_ocr_anonymization_async_destroy()
    except Exception as e:
        print("Exception when calling AnonymizationAsyncApi->ocr_ocr_anonymization_async_destroy: %s\n" % e)
```
...
# **ocr_ocr_anonymization_async_retrieve**
> ListAsyncJobResponse ocr_ocr_anonymization_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Anonymization List Job
        api_response = await api_instance.ocr_ocr_anonymization_async_retrieve()
        print("The response of AnonymizationAsyncApi->ocr_ocr_anonymization_async_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnonymizationAsyncApi->ocr_ocr_anonymization_async_retrieve: %s\n" % e)
```
...
# **ocr_ocr_anonymization_async_retrieve2**
> AsyncocranonymizationAsyncResponseModel ocr_ocr_anonymization_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Anonymization Get Job Results
        api_response = await api_instance.ocr_ocr_anonymization_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
        print("The response of AnonymizationAsyncApi->ocr_ocr_anonymization_async_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AnonymizationAsyncApi->ocr_ocr_anonymization_async_retrieve2: %s\n" % e)
```
...
[**AsyncocranonymizationAsyncResponseModel**](AsyncocranonymizationAsyncResponseModel.md)
