# openapi_client.ExplicitContentDetectionAsyncApi

All URIs are relative to *https://api.edenai.run/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**video_video_explicit_content_detection_async_create**](ExplicitContentDetectionAsyncApi.md#video_video_explicit_content_detection_async_create) | **POST** /video/explicit_content_detection_async | Video Explicit Content Detection Launch Job
[**video_video_explicit_content_detection_async_destroy**](ExplicitContentDetectionAsyncApi.md#video_video_explicit_content_detection_async_destroy) | **DELETE** /video/explicit_content_detection_async | Video Explicit Content delete Jobs
[**video_video_explicit_content_detection_async_retrieve**](ExplicitContentDetectionAsyncApi.md#video_video_explicit_content_detection_async_retrieve) | **GET** /video/explicit_content_detection_async | Video Explicit Content Detection List Jobs
[**video_video_explicit_content_detection_async_retrieve2**](ExplicitContentDetectionAsyncApi.md#video_video_explicit_content_detection_async_retrieve2) | **GET** /video/explicit_content_detection_async/{public_id} | Video Explicit Content Detection Get Job Results


# **video_video_explicit_content_detection_async_create**
> LaunchAsyncJobResponse video_video_explicit_content_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ExplicitContentDetectionAsyncApi(api_client)
    ...
    try:
        # Video Explicit Content Detection Launch Job
        api_response = await api_instance.video_video_explicit_content_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
        print("The response of ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_create: %s\n" % e)
```
...
# **video_video_explicit_content_detection_async_destroy**
> video_video_explicit_content_detection_async_destroy()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content delete Jobs
        await api_instance.video_video_explicit_content_detection_async_destroy()
    except Exception as e:
        print("Exception when calling ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_destroy: %s\n" % e)
```
...
# **video_video_explicit_content_detection_async_retrieve**
> ListAsyncJobResponse video_video_explicit_content_detection_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content Detection List Jobs
        api_response = await api_instance.video_video_explicit_content_detection_async_retrieve()
        print("The response of ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_retrieve: %s\n" % e)
```
...
# **video_video_explicit_content_detection_async_retrieve2**
> AsyncvideoexplicitContentDetectionAsyncResponseModel video_video_explicit_content_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content Detection Get Job Results
        api_response = await api_instance.video_video_explicit_content_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
        print("The response of ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExplicitContentDetectionAsyncApi->video_video_explicit_content_detection_async_retrieve2: %s\n" % e)
```
...
[**AsyncvideoexplicitContentDetectionAsyncResponseModel**](AsyncvideoexplicitContentDetectionAsyncResponseModel.md)
