...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Face Detection Launch Job
        api_response = await api_instance.video_video_face_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Face Detection delete Jobs
        await api_instance.video_video_face_detection_async_destroy()
    except Exception as e:
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Face Detection List Jobs
        api_response = await api_instance.video_video_face_detection_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Face Detection Get Job Results
        api_response = await api_instance.video_video_face_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
