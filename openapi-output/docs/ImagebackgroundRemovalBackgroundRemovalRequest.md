...
**provider_params** | **str** | Provider specific parameters | [optional] 
...
imagebackground_removal_background_removal_request_instance = ImagebackgroundRemovalBackgroundRemovalRequest.from_json(json)
# print the JSON string representation of the object
print(ImagebackgroundRemovalBackgroundRemovalRequest.to_json())

# convert the object into a dict
imagebackground_removal_background_removal_request_dict = imagebackground_removal_background_removal_request_instance.to_dict()
# create an instance of ImagebackgroundRemovalBackgroundRemovalRequest from a dict
imagebackground_removal_background_removal_request_form_dict = imagebackground_removal_background_removal_request.from_dict(imagebackground_removal_background_removal_request_dict)
```
