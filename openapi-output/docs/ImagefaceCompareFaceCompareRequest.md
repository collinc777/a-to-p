...
**file1** | **bytearray** | File to analyse in binary format to be used with *content-type*: **multipart/form-data** &lt;br&gt; **Does not work with application/json !** | [optional] 
**file1_url** | **str** | File **URL** to analyse to be used with with *content-type*: **application/json**. | [optional] 
**file2** | **bytearray** | File to analyse in binary format to be used with *content-type*: **multipart/form-data** &lt;br&gt; **Does not work with application/json !** | [optional] 
**file2_url** | **str** | File **URL** to analyse to be used with with *content-type*: **application/json**. | [optional] 
...
json = "{}"
# create an instance of ImagefaceCompareFaceCompareRequest from a JSON string
imageface_compare_face_compare_request_instance = ImagefaceCompareFaceCompareRequest.from_json(json)
# print the JSON string representation of the object
print(ImagefaceCompareFaceCompareRequest.to_json())

# convert the object into a dict
imageface_compare_face_compare_request_dict = imageface_compare_face_compare_request_instance.to_dict()
# create an instance of ImagefaceCompareFaceCompareRequest from a dict
imageface_compare_face_compare_request_form_dict = imageface_compare_face_compare_request.from_dict(imageface_compare_face_compare_request_dict)
```
