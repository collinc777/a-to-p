...
json = "{}"
# create an instance of ImagefaceDetectionFaceDetectionRequest from a JSON string
imageface_detection_face_detection_request_instance = ImagefaceDetectionFaceDetectionRequest.from_json(json)
# print the JSON string representation of the object
print(ImagefaceDetectionFaceDetectionRequest.to_json())

# convert the object into a dict
imageface_detection_face_detection_request_dict = imageface_detection_face_detection_request_instance.to_dict()
# create an instance of ImagefaceDetectionFaceDetectionRequest from a dict
imageface_detection_face_detection_request_form_dict = imageface_detection_face_detection_request.from_dict(imageface_detection_face_detection_request_dict)
```
