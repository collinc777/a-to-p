...
**resolution** | [**ResolutionEnum**](ResolutionEnum.md) |  | 
**num_images** | **int** | The number of images to generate. Must be between 1 and 10. | [optional] [default to 1]
...
json = "{}"
# create an instance of ImagegenerationGenerationRequest from a JSON string
imagegeneration_generation_request_instance = ImagegenerationGenerationRequest.from_json(json)
# print the JSON string representation of the object
print(ImagegenerationGenerationRequest.to_json())

# convert the object into a dict
imagegeneration_generation_request_dict = imagegeneration_generation_request_instance.to_dict()
# create an instance of ImagegenerationGenerationRequest from a dict
imagegeneration_generation_request_form_dict = imagegeneration_generation_request.from_dict(imagegeneration_generation_request_dict)
```
