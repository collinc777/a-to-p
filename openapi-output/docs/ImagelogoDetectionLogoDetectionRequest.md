...
json = "{}"
# create an instance of ImagelogoDetectionLogoDetectionRequest from a JSON string
imagelogo_detection_logo_detection_request_instance = ImagelogoDetectionLogoDetectionRequest.from_json(json)
# print the JSON string representation of the object
print(ImagelogoDetectionLogoDetectionRequest.to_json())

# convert the object into a dict
imagelogo_detection_logo_detection_request_dict = imagelogo_detection_logo_detection_request_instance.to_dict()
# create an instance of ImagelogoDetectionLogoDetectionRequest from a dict
imagelogo_detection_logo_detection_request_form_dict = imagelogo_detection_logo_detection_request.from_dict(imagelogo_detection_logo_detection_request_dict)
```
