# openapi_client.LabelDetectionAsyncApi

All URIs are relative to *https://api.edenai.run/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**video_video_label_detection_async_create**](LabelDetectionAsyncApi.md#video_video_label_detection_async_create) | **POST** /video/label_detection_async | Label Detection Launch Job
[**video_video_label_detection_async_destroy**](LabelDetectionAsyncApi.md#video_video_label_detection_async_destroy) | **DELETE** /video/label_detection_async | Label Detection delete Jobs
[**video_video_label_detection_async_retrieve**](LabelDetectionAsyncApi.md#video_video_label_detection_async_retrieve) | **GET** /video/label_detection_async | Label Detection List Jobs
[**video_video_label_detection_async_retrieve2**](LabelDetectionAsyncApi.md#video_video_label_detection_async_retrieve2) | **GET** /video/label_detection_async/{public_id} | Label Detection Get Job Results


# **video_video_label_detection_async_create**
> LaunchAsyncJobResponse video_video_label_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LabelDetectionAsyncApi(api_client)
    ...
    try:
        # Label Detection Launch Job
        api_response = await api_instance.video_video_label_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
        print("The response of LabelDetectionAsyncApi->video_video_label_detection_async_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LabelDetectionAsyncApi->video_video_label_detection_async_create: %s\n" % e)
```
...
# **video_video_label_detection_async_destroy**
> video_video_label_detection_async_destroy()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection delete Jobs
        await api_instance.video_video_label_detection_async_destroy()
    except Exception as e:
        print("Exception when calling LabelDetectionAsyncApi->video_video_label_detection_async_destroy: %s\n" % e)
```
...
# **video_video_label_detection_async_retrieve**
> ListAsyncJobResponse video_video_label_detection_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection List Jobs
        api_response = await api_instance.video_video_label_detection_async_retrieve()
        print("The response of LabelDetectionAsyncApi->video_video_label_detection_async_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LabelDetectionAsyncApi->video_video_label_detection_async_retrieve: %s\n" % e)
```
...
# **video_video_label_detection_async_retrieve2**
> AsyncvideolabelDetectionAsyncResponseModel video_video_label_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection Get Job Results
        api_response = await api_instance.video_video_label_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
        print("The response of LabelDetectionAsyncApi->video_video_label_detection_async_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LabelDetectionAsyncApi->video_video_label_detection_async_retrieve2: %s\n" % e)
```
...
[**AsyncvideolabelDetectionAsyncResponseModel**](AsyncvideolabelDetectionAsyncResponseModel.md)
