# openapi_client.LogoDetectionAsyncApi

All URIs are relative to *https://api.edenai.run/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**video_video_logo_detection_async_create**](LogoDetectionAsyncApi.md#video_video_logo_detection_async_create) | **POST** /video/logo_detection_async | Video Logo Detection Launch Job
[**video_video_logo_detection_async_destroy**](LogoDetectionAsyncApi.md#video_video_logo_detection_async_destroy) | **DELETE** /video/logo_detection_async | Video Logo Detection delete Jobs
[**video_video_logo_detection_async_retrieve**](LogoDetectionAsyncApi.md#video_video_logo_detection_async_retrieve) | **GET** /video/logo_detection_async | Video Logo Detection List Jobs
[**video_video_logo_detection_async_retrieve2**](LogoDetectionAsyncApi.md#video_video_logo_detection_async_retrieve2) | **GET** /video/logo_detection_async/{public_id} | Video Logo Detection Get Job Results


# **video_video_logo_detection_async_create**
> LaunchAsyncJobResponse video_video_logo_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)

Video Logo Detection Launch Job

<details><summary><strong style='color: #0072a3; cursor: pointer'>Available Providers</strong></summary>    |Provider|Version|Price|Billing unit| |----|-------|-----|------------| |**google**|`Video intelligence v1`|0.15 (per 60 seconde)|1 seconde |**twelvelabs**|`v1.1.2`|0.1 (per 60 seconde)|60 seconde   </details>  
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LogoDetectionAsyncApi(api_client)
    ...
    try:
        # Video Logo Detection Launch Job
        api_response = await api_instance.video_video_logo_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
        print("The response of LogoDetectionAsyncApi->video_video_logo_detection_async_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LogoDetectionAsyncApi->video_video_logo_detection_async_create: %s\n" % e)
```
...
# **video_video_logo_detection_async_destroy**
> video_video_logo_detection_async_destroy()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Logo Detection delete Jobs
        await api_instance.video_video_logo_detection_async_destroy()
    except Exception as e:
        print("Exception when calling LogoDetectionAsyncApi->video_video_logo_detection_async_destroy: %s\n" % e)
```
...
# **video_video_logo_detection_async_retrieve**
> ListAsyncJobResponse video_video_logo_detection_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Logo Detection List Jobs
        api_response = await api_instance.video_video_logo_detection_async_retrieve()
        print("The response of LogoDetectionAsyncApi->video_video_logo_detection_async_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LogoDetectionAsyncApi->video_video_logo_detection_async_retrieve: %s\n" % e)
```
...
# **video_video_logo_detection_async_retrieve2**
> AsyncvideologoDetectionAsyncResponseModel video_video_logo_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Logo Detection Get Job Results
        api_response = await api_instance.video_video_logo_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
        print("The response of LogoDetectionAsyncApi->video_video_logo_detection_async_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LogoDetectionAsyncApi->video_video_logo_detection_async_retrieve2: %s\n" % e)
```
...
[**AsyncvideologoDetectionAsyncResponseModel**](AsyncvideologoDetectionAsyncResponseModel.md)
