# openapi_client.ObjectTrackingAsyncApi

All URIs are relative to *https://api.edenai.run/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**video_video_object_tracking_async_create**](ObjectTrackingAsyncApi.md#video_video_object_tracking_async_create) | **POST** /video/object_tracking_async | Video Object Tracking Launch Job
[**video_video_object_tracking_async_destroy**](ObjectTrackingAsyncApi.md#video_video_object_tracking_async_destroy) | **DELETE** /video/object_tracking_async | Video Object Tracking delete Jobs
[**video_video_object_tracking_async_retrieve**](ObjectTrackingAsyncApi.md#video_video_object_tracking_async_retrieve) | **GET** /video/object_tracking_async | Video Object Tracking List Jobs
[**video_video_object_tracking_async_retrieve2**](ObjectTrackingAsyncApi.md#video_video_object_tracking_async_retrieve2) | **GET** /video/object_tracking_async/{public_id} | Video Object Tracking Get Job Results


# **video_video_object_tracking_async_create**
> LaunchAsyncJobResponse video_video_object_tracking_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)

Video Object Tracking Launch Job

<details><summary><strong style='color: #0072a3; cursor: pointer'>Available Providers</strong></summary>    |Provider|Version|Price|Billing unit| |----|-------|-----|------------| |**google**|`Video intelligence v1`|0.15 (per 60 seconde)|1 seconde   </details>  
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ObjectTrackingAsyncApi(api_client)
    ...
    try:
        # Video Object Tracking Launch Job
        api_response = await api_instance.video_video_object_tracking_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
        print("The response of ObjectTrackingAsyncApi->video_video_object_tracking_async_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectTrackingAsyncApi->video_video_object_tracking_async_create: %s\n" % e)
```
...
# **video_video_object_tracking_async_destroy**
> video_video_object_tracking_async_destroy()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking delete Jobs
        await api_instance.video_video_object_tracking_async_destroy()
    except Exception as e:
        print("Exception when calling ObjectTrackingAsyncApi->video_video_object_tracking_async_destroy: %s\n" % e)
```
...
# **video_video_object_tracking_async_retrieve**
> ListAsyncJobResponse video_video_object_tracking_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking List Jobs
        api_response = await api_instance.video_video_object_tracking_async_retrieve()
        print("The response of ObjectTrackingAsyncApi->video_video_object_tracking_async_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectTrackingAsyncApi->video_video_object_tracking_async_retrieve: %s\n" % e)
```
...
# **video_video_object_tracking_async_retrieve2**
> AsyncvideoobjectTrackingAsyncResponseModel video_video_object_tracking_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking Get Job Results
        api_response = await api_instance.video_video_object_tracking_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
        print("The response of ObjectTrackingAsyncApi->video_video_object_tracking_async_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectTrackingAsyncApi->video_video_object_tracking_async_retrieve2: %s\n" % e)
```
...
[**AsyncvideoobjectTrackingAsyncResponseModel**](AsyncvideoobjectTrackingAsyncResponseModel.md)
