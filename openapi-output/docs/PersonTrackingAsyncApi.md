# openapi_client.PersonTrackingAsyncApi
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Person Tracking Launch Job
        api_response = await api_instance.video_video_person_tracking_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Person Tracking delete Jobs
        await api_instance.video_video_person_tracking_async_destroy()
    except Exception as e:
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Person Tracking List Jobs
        api_response = await api_instance.video_video_person_tracking_async_retrieve()
...
async with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Person Tracking Get Job Results
        api_response = await api_instance.video_video_person_tracking_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
