...
json = "{}"
# create an instance of TranslationdocumentTranslationDocumentTranslationRequest from a JSON string
translationdocument_translation_document_translation_request_instance = TranslationdocumentTranslationDocumentTranslationRequest.from_json(json)
# print the JSON string representation of the object
print(TranslationdocumentTranslationDocumentTranslationRequest.to_json())

# convert the object into a dict
translationdocument_translation_document_translation_request_dict = translationdocument_translation_document_translation_request_instance.to_dict()
# create an instance of TranslationdocumentTranslationDocumentTranslationRequest from a dict
translationdocument_translation_document_translation_request_form_dict = translationdocument_translation_document_translation_request.from_dict(translationdocument_translation_document_translation_request_dict)
```
