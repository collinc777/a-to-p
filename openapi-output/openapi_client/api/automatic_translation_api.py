...
class AutomaticTranslationApi:
    ...
    @validate_call
    async def translation_translation_automatic_translation_create(
        self,
    ...
    @validate_call
    async def translation_translation_automatic_translation_create_with_http_info(
        self,
        translationautomatic_translation_automatic_translation_request: TranslationautomaticTranslationAutomaticTranslationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def translation_translation_automatic_translation_create_without_preload_content(
        self,
        translationautomatic_translation_automatic_translation_request: TranslationautomaticTranslationAutomaticTranslationRequest,
        _request_timeout: Union[
            None,
    ...
    def _translation_translation_automatic_translation_create_serialize(
        ...
        if translationautomatic_translation_automatic_translation_request is not None:
            _body_params = translationautomatic_translation_automatic_translation_request
