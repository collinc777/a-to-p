...
class CustomDocumentParsingAsyncApi:
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_create(
        self,
        ...
        queries: Annotated[str, Field(min_length=1, strict=True, description="Your queries need to be a list of dict containing the questions you want answered and the page to look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your pages'}]'")],
        ...
        file: Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="File to analyse in binary format to be used with *content-type*: **multipart/form-data** <br> **Does not work with application/json !**")] = None,
        ...
        file_password: Annotated[Optional[Annotated[str, Field(strict=True, max_length=200)]], Field(description="If your PDF file has a password, you can pass it here!")] = None,
        convert_to_pdf: Annotated[Optional[StrictBool], Field(description="Boolean value to specify weather to convert the doc/docx files to pdf format to be accepted by a majority of the providers")] = None,
        ...
        :type providers: str
        :param queries: Your queries need to be a list of dict containing the questions you want answered and the page to look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your pages'}]' (required)
        :type queries: str
        ...
        :param convert_to_pdf: Boolean value to specify weather to convert the doc/docx files to pdf format to be accepted by a majority of the providers
        ...
        _param = self._ocr_ocr_custom_document_parsing_async_create_serialize(
            providers=providers,
            queries=queries,
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_create_with_http_info(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        queries: Annotated[str, Field(min_length=1, strict=True, description="Your queries need to be a list of dict containing the questions you want answered and the page to look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your pages'}]'")],
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_create_without_preload_content(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        queries: Annotated[str, Field(min_length=1, strict=True, description="Your queries need to be a list of dict containing the questions you want answered and the page to look for the information in :  '[{'query':'your query','pages':'your pages'},{'query':'your query','pages':'your pages'}]'")],
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
    ...
    def _ocr_ocr_custom_document_parsing_async_create_serialize(
        self,
        providers,
        queries,
        fallback_providers,
        ...
        if queries is not None:
            _form_params.append(('queries', queries))
        if convert_to_pdf is not None:
            _form_params.append(('convert_to_pdf', convert_to_pdf))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ocr/custom_document_parsing_async',
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_destroy(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._ocr_ocr_custom_document_parsing_async_destroy_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_destroy_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_destroy_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _ocr_ocr_custom_document_parsing_async_destroy_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._ocr_ocr_custom_document_parsing_async_retrieve_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _ocr_ocr_custom_document_parsing_async_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve2(
        self,
        public_id: StrictStr,
        ...
        _param = self._ocr_ocr_custom_document_parsing_async_retrieve2_serialize(
            public_id=public_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AsyncocrcustomDocumentParsingAsyncResponseModel",
            '400': "BadRequest",
            '500': "Error",
            '403': "Error",
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve2_with_http_info(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AsyncocrcustomDocumentParsingAsyncResponseModel]:
        """Custom Document Parsing Get Job Results
    ...
    @validate_call
    async def ocr_ocr_custom_document_parsing_async_retrieve2_without_preload_content(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
    ...
    def _ocr_ocr_custom_document_parsing_async_retrieve2_serialize(
        self,
        public_id,
        response_as_dict,
        show_original_response,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ocr/custom_document_parsing_async/{public_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
