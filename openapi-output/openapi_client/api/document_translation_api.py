...
class DocumentTranslationApi:
    ...
    @validate_call
    async def translation_translation_document_translation_create(
        self,
    ...
    @validate_call
    async def translation_translation_document_translation_create_with_http_info(
        self,
        translationdocument_translation_document_translation_request: TranslationdocumentTranslationDocumentTranslationRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def translation_translation_document_translation_create_without_preload_content(
        self,
        translationdocument_translation_document_translation_request: TranslationdocumentTranslationDocumentTranslationRequest,
        _request_timeout: Union[
            None,
