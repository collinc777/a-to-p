...
class FaceRecognitionApi:
    ...
    @validate_call
    async def image_image_face_recognition_add_face_create(
        self,
    ...
    @validate_call
    async def image_image_face_recognition_add_face_create_with_http_info(
        self,
        imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request: ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def image_image_face_recognition_add_face_create_without_preload_content(
        self,
        imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request: ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest,
        _request_timeout: Union[
            None,
    ...
    def _image_image_face_recognition_add_face_create_serialize(
        ...
        if imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request is not None:
    ...
    @validate_call
    async def image_image_face_recognition_delete_face_create(
        self,
    ...
    @validate_call
    async def image_image_face_recognition_delete_face_create_with_http_info(
        self,
        imageface_recognitiondelete_face_face_recognition_delete_face_request: ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def image_image_face_recognition_delete_face_create_without_preload_content(
        self,
        imageface_recognitiondelete_face_face_recognition_delete_face_request: ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest,
        _request_timeout: Union[
            None,
    ...
    def _image_image_face_recognition_delete_face_create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if imageface_recognitiondelete_face_face_recognition_delete_face_request is not None:
            _body_params = imageface_recognitiondelete_face_face_recognition_delete_face_request
    ...
    @validate_call
    async def image_image_face_recognition_list_faces_retrieve(
        self,
    ...
    @validate_call
    async def image_image_face_recognition_list_faces_retrieve_with_http_info(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        attributes_as_list: Annotated[Optional[StrictBool], Field(description="Optional : When set to **false** (default) the structure of the extracted items is list of objects having different attributes : <br>      ```{'items': [{\"attribute_1\": \"x1\",\"attribute_2\": \"y2\"}, ... ]}``` <br>      When it is set to **true**, the response contains an object with each attribute as a list : <br>      ```{ \"attribute_1\": [\"x1\",\"x2\", ...], \"attribute_2\": [y1, y2, ...]}``` ")] = None,
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
    ...
    @validate_call
    async def image_image_face_recognition_list_faces_retrieve_without_preload_content(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        attributes_as_list: Annotated[Optional[StrictBool], Field(description="Optional : When set to **false** (default) the structure of the extracted items is list of objects having different attributes : <br>      ```{'items': [{\"attribute_1\": \"x1\",\"attribute_2\": \"y2\"}, ... ]}``` <br>      When it is set to **true**, the response contains an object with each attribute as a list : <br>      ```{ \"attribute_1\": [\"x1\",\"x2\", ...], \"attribute_2\": [y1, y2, ...]}``` ")] = None,
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
    ...
    @validate_call
    async def image_image_face_recognition_recognize_create(
        self,
        imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request: ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def image_image_face_recognition_recognize_create_with_http_info(
        self,
        imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request: ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def image_image_face_recognition_recognize_create_without_preload_content(
        self,
        imageface_recognitionrecognizeimageface_recognitionadd_face_face_recognition_detect_face_request: ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest,
        _request_timeout: Union[
            None,
