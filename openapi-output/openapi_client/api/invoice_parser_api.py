...
class InvoiceParserApi:
    ...
    @validate_call
    async def ocr_ocr_invoice_parser_create(
        self,
    ...
    @validate_call
    async def ocr_ocr_invoice_parser_create_with_http_info(
        self,
        ocrinvoice_parser_invoice_parser_request: OcrinvoiceParserInvoiceParserRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def ocr_ocr_invoice_parser_create_without_preload_content(
        self,
        ocrinvoice_parser_invoice_parser_request: OcrinvoiceParserInvoiceParserRequest,
        _request_timeout: Union[
            None,
