...
class LogoDetectionAsyncApi:
    ...
    @validate_call
    async def video_video_logo_detection_async_create(
        self,
        ...
        _param = self._video_video_logo_detection_async_create_serialize(
            providers=providers,
    ...
    @validate_call
    async def video_video_logo_detection_async_create_with_http_info(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
        show_original_response: Annotated[Optional[StrictBool], Field(description="Optional : Shows the original response of the provider.<br>         When set to **true**, a new attribute *original_response* will appear in the response object.")] = None,
    ...
    @validate_call
    async def video_video_logo_detection_async_create_without_preload_content(
        self,
        providers: Annotated[str, Field(min_length=1, strict=True, description="It can be one (ex: **'amazon'** or **'google'**) or multiple provider(s) (ex: **'amazon,microsoft,google'**)             that the data will be redirected to in order to get the processed results.")],
        fallback_providers: Annotated[Optional[StrictStr], Field(description="Providers in this list will be used as fallback if the call to provider in `providers` parameter fails.     To use this feature, you must input **only one** provider in the `providers` parameter. but you can put up to 5 fallbacks.  They will be tried in the same order they are input, and it will stop to the first provider who doesn't fail.   *Doesn't work with async subfeatures.*     ")] = None,
        show_original_response: Annotated[Optional[StrictBool], Field(description="Optional : Shows the original response of the provider.<br>         When set to **true**, a new attribute *original_response* will appear in the response object.")] = None,
    ...
    def _video_video_logo_detection_async_create_serialize(
        self,
        providers,
        fallback_providers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/video/logo_detection_async',
    ...
    @validate_call
    async def video_video_logo_detection_async_destroy(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._video_video_logo_detection_async_destroy_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def video_video_logo_detection_async_destroy_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def video_video_logo_detection_async_destroy_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _video_video_logo_detection_async_destroy_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._video_video_logo_detection_async_retrieve_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _video_video_logo_detection_async_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve2(
        self,
        public_id: StrictStr,
        ...
        _param = self._video_video_logo_detection_async_retrieve2_serialize(
            public_id=public_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AsyncvideologoDetectionAsyncResponseModel",
            '400': "BadRequest",
            '500': "Error",
            '403': "Error",
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve2_with_http_info(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AsyncvideologoDetectionAsyncResponseModel]:
        """Video Logo Detection Get Job Results
    ...
    @validate_call
    async def video_video_logo_detection_async_retrieve2_without_preload_content(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
    ...
    def _video_video_logo_detection_async_retrieve2_serialize(
        self,
        public_id,
        response_as_dict,
        show_original_response,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/video/logo_detection_async/{public_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
