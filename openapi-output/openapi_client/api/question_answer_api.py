...
class QuestionAnswerApi:
    ...
    @validate_call
    async def image_image_question_answer_create(
        self,
    ...
    @validate_call
    async def image_image_question_answer_create_with_http_info(
        self,
        imagequestion_answer_question_answer_request: ImagequestionAnswerQuestionAnswerRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def image_image_question_answer_create_without_preload_content(
        self,
        imagequestion_answer_question_answer_request: ImagequestionAnswerQuestionAnswerRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def text_text_question_answer_create(
        self,
    ...
    @validate_call
    async def text_text_question_answer_create_with_http_info(
        self,
        textquestion_answer_question_answer_request: TextquestionAnswerQuestionAnswerRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def text_text_question_answer_create_without_preload_content(
        self,
        textquestion_answer_question_answer_request: TextquestionAnswerQuestionAnswerRequest,
        _request_timeout: Union[
            None,
