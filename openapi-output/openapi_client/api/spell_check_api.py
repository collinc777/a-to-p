...
class SpellCheckApi:
    ...
    @validate_call
    async def text_text_spell_check_create(
        self,
    ...
    @validate_call
    async def text_text_spell_check_create_with_http_info(
        self,
        textspell_check_spell_check_request: TextspellCheckSpellCheckRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def text_text_spell_check_create_without_preload_content(
        self,
        textspell_check_spell_check_request: TextspellCheckSpellCheckRequest,
        _request_timeout: Union[
            None,
