...
class AsyncVideoAnalysisRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "show_original_response", "webhook_receiver", "users_webhook_parameters", "file", "file_url"]
    ...
    def file_validate_regular_expression(cls, value):
        ...
        if not re.match(r"(?:mov|mp4|avi)$", value):
            raise ValueError(r"must validate the regular expression /(?:mov|mp4|avi)$/")
        return value
