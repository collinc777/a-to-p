...
class AsyncvideofaceDetectionAsyncResponseModel(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": VideofaceDetectionAsyncModel.from_dict(obj["results"]) if obj.get("results") is not None else None,
            "error": obj.get("error"),
