...
class AudiotextToSpeechAsyncModel(BaseModel):
    """
    AudiotextToSpeechAsyncModel
    """ # noqa: E501
    lovoai: Optional[PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364762288] = None
    amazon: Optional[PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364511728] = None
    __properties: ClassVar[List[str]] = ["lovoai", "amazon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lovoai": PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364762288.from_dict(obj["lovoai"]) if obj.get("lovoai") is not None else None,
            "amazon": PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364511728.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None
        })
        return _obj
