...
class AutomlClassificationUploadDataRequest(BaseModel):
    """
    ...
    project_id: Annotated[str, Field(min_length=1, strict=True, max_length=250)] = Field(description="The id of project")
    label: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(description="Label of the image")
    type_of_data: TypeOfDataEnum = Field(description="Type of data : TRAINING or TEST  * `TRAINING` - TRAINING * `TEST` - TEST")
    ...
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "show_original_response", "webhook_receiver", "users_webhook_parameters", "project_id", "label", "type_of_data", "file", "file_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "type_of_data": obj.get("type_of_data"),
            "file": obj.get("file"),
