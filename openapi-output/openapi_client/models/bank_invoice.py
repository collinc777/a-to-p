...
class BankInvoice(BaseModel):
    ...
    rooting_number: StrictStr
    swift: StrictStr
    __properties: ClassVar[List[str]] = ["account_number", "iban", "bsb", "sort_code", "vat_number", "rooting_number", "swift"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rooting_number": obj.get("rooting_number"),
            "swift": obj.get("swift")
        })
        return _obj
