...
class CustomDocumentParsingAsyncItem(BaseModel):
    ...
    page: StrictInt
    __properties: ClassVar[List[str]] = ["confidence", "value", "query", "bounding_box", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "query": obj.get("query"),
            "bounding_box": CustomDocumentParsingAsyncBoundingBox.from_dict(obj["bounding_box"]) if obj.get("bounding_box") is not None else None,
            "page": obj.get("page")
        })
        return _obj
