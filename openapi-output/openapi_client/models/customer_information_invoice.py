...
class CustomerInformationInvoice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customer_name", "customer_address", "customer_email", "customer_id", "customer_tax_id", "customer_mailing_address", "customer_billing_address", "customer_shipping_address", "customer_service_address", "customer_remittance_address", "abn_number", "gst_number", "pan_number", "vat_number", "siret_number", "siren_number"]
