...
class FaceMatch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["confidence", "bounding_box"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bounding_box": FaceCompareBoundingBox.from_dict(obj["bounding_box"]) if obj.get("bounding_box") is not None else None
        })
        return _obj
