...
class ImageanonymizationAnonymizationDataClass(BaseModel):
    """
    ImageanonymizationAnonymizationDataClass
    """ # noqa: E501
    image: StrictStr
    image_resource_url: StrictStr
    items: Optional[List[AnonymizationItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["image", "image_resource_url", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AnonymizationItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
