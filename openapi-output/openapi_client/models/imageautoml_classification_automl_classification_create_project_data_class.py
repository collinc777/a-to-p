...
class ImageautomlClassificationAutomlClassificationCreateProjectDataClass(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "project_id", "original_response", "status"]
