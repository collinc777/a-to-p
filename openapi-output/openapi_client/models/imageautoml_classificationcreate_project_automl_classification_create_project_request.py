...
class ImageautomlClassificationcreateProjectAutomlClassificationCreateProjectRequest(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=250)]] = Field(default=None, description="Name of your project")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "name"]
