...
class ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "project_id"]
