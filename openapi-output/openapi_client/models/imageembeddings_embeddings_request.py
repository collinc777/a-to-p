...
class ImageembeddingsEmbeddingsRequest(BaseModel):
    ...
    representation: RepresentationEnum = Field(description="The type of embedding representation to embed the image with  * `document` - document * `query` - query * `symetric` - symetric")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "settings", "file", "file_url", "representation"]
