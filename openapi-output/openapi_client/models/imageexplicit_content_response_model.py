...
class ImageexplicitContentResponseModel(BaseModel):
    ...
    """ # noqa: E501
    microsoft: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364580432] = None
    google: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364576064] = None
    picpurify: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364577008] = None
    amazon: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364419072] = None
    clarifai: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559359385712] = None
    api4ai: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364226640] = None
    sentisight: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364235088] = None
    eden_ai: Optional[PydanticMainImageexplicitContentExplicitContentDataClass94559364245872] = Field(default=None, alias="eden-ai")
    __properties: ClassVar[List[str]] = ["microsoft", "google", "picpurify", "amazon", "clarifai", "api4ai", "sentisight", "eden-ai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "microsoft": PydanticMainImageexplicitContentExplicitContentDataClass94559364580432.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": PydanticMainImageexplicitContentExplicitContentDataClass94559364576064.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "picpurify": PydanticMainImageexplicitContentExplicitContentDataClass94559364577008.from_dict(obj["picpurify"]) if obj.get("picpurify") is not None else None,
            "amazon": PydanticMainImageexplicitContentExplicitContentDataClass94559364419072.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "clarifai": PydanticMainImageexplicitContentExplicitContentDataClass94559359385712.from_dict(obj["clarifai"]) if obj.get("clarifai") is not None else None,
            "api4ai": PydanticMainImageexplicitContentExplicitContentDataClass94559364226640.from_dict(obj["api4ai"]) if obj.get("api4ai") is not None else None,
            "sentisight": PydanticMainImageexplicitContentExplicitContentDataClass94559364235088.from_dict(obj["sentisight"]) if obj.get("sentisight") is not None else None,
            "eden-ai": PydanticMainImageexplicitContentExplicitContentDataClass94559364245872.from_dict(obj["eden-ai"]) if obj.get("eden-ai") is not None else None
        })
        return _obj
