...
class ImagefaceCompareFaceCompareRequest(BaseModel):
    """
    ...
    file1: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="File to analyse in binary format to be used with *content-type*: **multipart/form-data** <br> **Does not work with application/json !**")
    file1_url: Optional[StrictStr] = Field(default=None, description="File **URL** to analyse to be used with with *content-type*: **application/json**.")
    file2: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="File to analyse in binary format to be used with *content-type*: **multipart/form-data** <br> **Does not work with application/json !**")
    file2_url: Optional[StrictStr] = Field(default=None, description="File **URL** to analyse to be used with with *content-type*: **application/json**.")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "file1", "file1_url", "file2", "file2_url"]

    @field_validator('file1')
    def file1_validate_regular_expression(cls, value):
    ...
    def file2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if file1_url (nullable) is None
        # and model_fields_set contains the field
        if self.file1_url is None and "file1_url" in self.model_fields_set:
            _dict['file1_url'] = None

        # set to None if file2_url (nullable) is None
        # and model_fields_set contains the field
        if self.file2_url is None and "file2_url" in self.model_fields_set:
            _dict['file2_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file1": obj.get("file1"),
            "file1_url": obj.get("file1_url"),
            "file2": obj.get("file2"),
            "file2_url": obj.get("file2_url")
        })
        return _obj
