...
class ImagefaceRecognitiondeleteFaceFaceRecognitionDeleteFaceRequest(BaseModel):
    ...
    face_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="ID of face to delete")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "face_id"]
