...
class ImagefaceRecognitionrecognizeimagefaceRecognitionaddFaceFaceRecognitionDetectFaceRequest(BaseModel):
    """
    ...
    def file_validate_regular_expression(cls, value):
        ...
        if not re.match(r"(?:jpg|jpeg|png|bmp)$", value):
            raise ValueError(r"must validate the regular expression /(?:jpg|jpeg|png|bmp)$/")
        return value
