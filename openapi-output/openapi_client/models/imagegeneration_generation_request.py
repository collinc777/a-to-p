...
class ImagegenerationGenerationRequest(BaseModel):
    """
    ...
    text: Annotated[str, Field(min_length=1, strict=True, max_length=1000)] = Field(description="Description of the desired image(s). The maximum length is 1000 characters")
    resolution: ResolutionEnum
    num_images: Optional[Annotated[int, Field(le=10, strict=True, ge=1)]] = Field(default=1, description="The number of images to generate. Must be between 1 and 10.")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "settings", "text", "resolution", "num_images"]
