...
class ImagelandmarkDetectionResponseModel(BaseModel):
    ...
    """ # noqa: E501
    microsoft: Optional[PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559364432112] = None
    google: Optional[PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559363407136] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "microsoft": PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559364432112.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559363407136.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
