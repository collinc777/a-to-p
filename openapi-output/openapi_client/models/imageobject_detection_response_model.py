...
class ImageobjectDetectionResponseModel(BaseModel):
    ...
    """ # noqa: E501
    microsoft: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559364505280] = None
    google: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559364672352] = None
    amazon: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559363088864] = None
    clarifai: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559364336912] = None
    api4ai: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559364500192] = None
    sentisight: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559359062944] = None
    eden_ai: Optional[PydanticMainImageobjectDetectionObjectDetectionDataClass94559359068400] = Field(default=None, alias="eden-ai")
    __properties: ClassVar[List[str]] = ["microsoft", "google", "amazon", "clarifai", "api4ai", "sentisight", "eden-ai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "microsoft": PydanticMainImageobjectDetectionObjectDetectionDataClass94559364505280.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": PydanticMainImageobjectDetectionObjectDetectionDataClass94559364672352.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "amazon": PydanticMainImageobjectDetectionObjectDetectionDataClass94559363088864.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "clarifai": PydanticMainImageobjectDetectionObjectDetectionDataClass94559364336912.from_dict(obj["clarifai"]) if obj.get("clarifai") is not None else None,
            "api4ai": PydanticMainImageobjectDetectionObjectDetectionDataClass94559364500192.from_dict(obj["api4ai"]) if obj.get("api4ai") is not None else None,
            "sentisight": PydanticMainImageobjectDetectionObjectDetectionDataClass94559359062944.from_dict(obj["sentisight"]) if obj.get("sentisight") is not None else None,
            "eden-ai": PydanticMainImageobjectDetectionObjectDetectionDataClass94559359068400.from_dict(obj["eden-ai"]) if obj.get("eden-ai") is not None else None
        })
        return _obj
