...
class ImagesearchResponseModel(BaseModel):
    ...
    """ # noqa: E501
    nyckel: Optional[PydanticMainImagesearchSearchDeleteImageDataClass94559363495072] = None
    sentisight: Optional[PydanticMainImagesearchSearchDeleteImageDataClass94559363496016] = None
    __properties: ClassVar[List[str]] = ["nyckel", "sentisight"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nyckel
        if self.nyckel:
            _dict['nyckel'] = self.nyckel.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nyckel": PydanticMainImagesearchSearchDeleteImageDataClass94559363495072.from_dict(obj["nyckel"]) if obj.get("nyckel") is not None else None,
            "sentisight": PydanticMainImagesearchSearchDeleteImageDataClass94559363496016.from_dict(obj["sentisight"]) if obj.get("sentisight") is not None else None
        })
        return _obj
