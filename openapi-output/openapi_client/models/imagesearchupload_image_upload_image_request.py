...
class ImagesearchuploadImageUploadImageRequest(BaseModel):
    ...
    image_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The image name need to have the extension of the file.")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "file", "file_url", "image_name"]
