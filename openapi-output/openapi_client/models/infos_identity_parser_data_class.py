...
class InfosIdentityParserDataClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["last_name", "given_names", "birth_place", "birth_date", "issuance_date", "expire_date", "document_id", "issuing_state", "address", "age", "country", "document_type", "gender", "image_id", "image_signature", "mrz", "nationality"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "last_name": ItemIdentityParserDataClass.from_dict(obj["last_name"]) if obj.get("last_name") is not None else None,
            "given_names": [ItemIdentityParserDataClass.from_dict(_item) for _item in obj["given_names"]] if obj.get("given_names") is not None else None,
            "birth_place": ItemIdentityParserDataClass.from_dict(obj["birth_place"]) if obj.get("birth_place") is not None else None,
            "birth_date": ItemIdentityParserDataClass.from_dict(obj["birth_date"]) if obj.get("birth_date") is not None else None,
            "issuance_date": ItemIdentityParserDataClass.from_dict(obj["issuance_date"]) if obj.get("issuance_date") is not None else None,
            "expire_date": ItemIdentityParserDataClass.from_dict(obj["expire_date"]) if obj.get("expire_date") is not None else None,
            "document_id": ItemIdentityParserDataClass.from_dict(obj["document_id"]) if obj.get("document_id") is not None else None,
            "issuing_state": ItemIdentityParserDataClass.from_dict(obj["issuing_state"]) if obj.get("issuing_state") is not None else None,
            "address": ItemIdentityParserDataClass.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "age": ItemIdentityParserDataClass.from_dict(obj["age"]) if obj.get("age") is not None else None,
            "country": Country.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "document_type": ItemIdentityParserDataClass.from_dict(obj["document_type"]) if obj.get("document_type") is not None else None,
            "gender": ItemIdentityParserDataClass.from_dict(obj["gender"]) if obj.get("gender") is not None else None,
            "image_id": [ItemIdentityParserDataClass.from_dict(_item) for _item in obj["image_id"]] if obj.get("image_id") is not None else None,
            "image_signature": [ItemIdentityParserDataClass.from_dict(_item) for _item in obj["image_signature"]] if obj.get("image_signature") is not None else None,
            "mrz": ItemIdentityParserDataClass.from_dict(obj["mrz"]) if obj.get("mrz") is not None else None,
            "nationality": ItemIdentityParserDataClass.from_dict(obj["nationality"]) if obj.get("nationality") is not None else None
        })
        return _obj
