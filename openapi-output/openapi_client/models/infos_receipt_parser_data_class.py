...
class InfosReceiptParserDataClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["invoice_number", "invoice_total", "invoice_subtotal", "barcodes", "category", "date", "due_date", "time", "customer_information", "merchant_information", "payment_information", "locale", "taxes", "receipt_infos", "item_lines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time": obj.get("time"),
            "customer_information": CustomerInformation.from_dict(obj["customer_information"]) if obj.get("customer_information") is not None else None,
            "merchant_information": MerchantInformation.from_dict(obj["merchant_information"]) if obj.get("merchant_information") is not None else None,
            "payment_information": PaymentInformation.from_dict(obj["payment_information"]) if obj.get("payment_information") is not None else None,
            "locale": Locale.from_dict(obj["locale"]) if obj.get("locale") is not None else None,
            ...
            "item_lines": [ItemLines.from_dict(_item) for _item in obj["item_lines"]] if obj.get("item_lines") is not None else None
        })
        return _obj
