...
class LandmarkItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "confidence", "bounding_box", "locations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bounding_box": [LandmarkVertice.from_dict(_item) for _item in obj["bounding_box"]] if obj.get("bounding_box") is not None else None,
            "locations": [LandmarkLocation.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None
        })
        return _obj
