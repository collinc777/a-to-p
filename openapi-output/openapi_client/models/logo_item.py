...
class LogoItem(BaseModel):
    ...
    score: StrictInt
    __properties: ClassVar[List[str]] = ["bounding_poly", "description", "score"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bounding_poly:
            _dict['bounding_poly'] = self.bounding_poly.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bounding_poly": LogoBoundingPoly.from_dict(obj["bounding_poly"]) if obj.get("bounding_poly") is not None else None,
