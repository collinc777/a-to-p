...
class LogoTrack(BaseModel):
    ...
    tracking: Optional[List[VideoLogo]] = None
    __properties: ClassVar[List[str]] = ["description", "tracking"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tracking": [VideoLogo.from_dict(_item) for _item in obj["tracking"]] if obj.get("tracking") is not None else None
        })
        return _obj
