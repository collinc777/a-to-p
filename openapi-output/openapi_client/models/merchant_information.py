...
class MerchantInformation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["merchant_name", "merchant_address", "merchant_phone", "merchant_url", "merchant_siret", "merchant_siren", "merchant_vat_number", "merchant_gst_number", "merchant_abn_number"]
