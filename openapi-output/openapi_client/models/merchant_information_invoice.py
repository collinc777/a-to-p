...
class MerchantInformationInvoice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["merchant_name", "merchant_address", "merchant_phone", "merchant_email", "merchant_fax", "merchant_website", "merchant_tax_id", "merchant_siret", "merchant_siren", "abn_number", "gst_number", "pan_number", "vat_number"]
