...
class ObjectTrack(BaseModel):
    ...
    frames: Optional[List[ObjectFrame]] = None
    __properties: ClassVar[List[str]] = ["description", "confidence", "frames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frames": [ObjectFrame.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None
        })
        return _obj
