...
class OcrcustomDocumentParsingAsyncModel(BaseModel):
    ...
    """ # noqa: E501
    extracta: Optional[PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367856608] = None
    amazon: Optional[PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367623088] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extracta": PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367856608.from_dict(obj["extracta"]) if obj.get("extracta") is not None else None,
            "amazon": PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367623088.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None
        })
        return _obj
