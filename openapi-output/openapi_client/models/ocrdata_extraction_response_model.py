...
class OcrdataExtractionResponseModel(BaseModel):
    ...
    """ # noqa: E501
    var_base64: Optional[PydanticMainOcrdataExtractionDataExtractionDataClass94559367954208] = Field(default=None, alias="base64")
    amazon: Optional[PydanticMainOcrdataExtractionDataExtractionDataClass94559367957968] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base64": PydanticMainOcrdataExtractionDataExtractionDataClass94559367954208.from_dict(obj["base64"]) if obj.get("base64") is not None else None,
            "amazon": PydanticMainOcrdataExtractionDataExtractionDataClass94559367957968.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None
        })
        return _obj
