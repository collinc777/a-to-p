...
class OcrfinancialParserFinancialParserRequest(BaseModel):
    """
    ...
    file_password: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="If your PDF file has a password, you can pass it here!")
    language: Optional[StrictStr] = Field(default=None, description="Language code of the language the document is written in (ex: fr (French), en (English), es (Spanish))")
    document_type: Optional[DocumentTypeEnum] = Field(default=None, description="Specify the type of your document. Can be Set to 'auto-detect' for automatic detection if the provider supports it. Otherwise, the default is 'invoice'.  * `auto-detect` - auto-detect * `invoice` - invoice * `receipt` - receipt")
    convert_to_pdf: Optional[StrictBool] = Field(default=False, description="Boolean value to specify weather to convert the doc/docx files to pdf format to be accepted by a majority of the providers")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "file", "file_url", "file_password", "language", "document_type", "convert_to_pdf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "convert_to_pdf": obj.get("convert_to_pdf") if obj.get("convert_to_pdf") is not None else False
        })
        return _obj
