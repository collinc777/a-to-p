...
class OcrfinancialParserResponseModel(BaseModel):
    """
    OcrfinancialParserResponseModel
    """ # noqa: E501
    klippa: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368362000] = None
    mindee: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368394720] = None
    affinda: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368403872] = None
    microsoft: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368040656] = None
    tabscanner: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368375168] = None
    google: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368050944] = None
    amazon: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368080832] = None
    dataleon: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368057200] = None
    veryfi: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368405584] = None
    var_base64: Optional[PydanticMainOcrfinancialParserFinancialParserDataClass94559368274592] = Field(default=None, alias="base64")
    __properties: ClassVar[List[str]] = ["klippa", "mindee", "affinda", "microsoft", "tabscanner", "google", "amazon", "dataleon", "veryfi", "base64"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "klippa": PydanticMainOcrfinancialParserFinancialParserDataClass94559368362000.from_dict(obj["klippa"]) if obj.get("klippa") is not None else None,
            "mindee": PydanticMainOcrfinancialParserFinancialParserDataClass94559368394720.from_dict(obj["mindee"]) if obj.get("mindee") is not None else None,
            "affinda": PydanticMainOcrfinancialParserFinancialParserDataClass94559368403872.from_dict(obj["affinda"]) if obj.get("affinda") is not None else None,
            "microsoft": PydanticMainOcrfinancialParserFinancialParserDataClass94559368040656.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "tabscanner": PydanticMainOcrfinancialParserFinancialParserDataClass94559368375168.from_dict(obj["tabscanner"]) if obj.get("tabscanner") is not None else None,
            "google": PydanticMainOcrfinancialParserFinancialParserDataClass94559368050944.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "amazon": PydanticMainOcrfinancialParserFinancialParserDataClass94559368080832.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "dataleon": PydanticMainOcrfinancialParserFinancialParserDataClass94559368057200.from_dict(obj["dataleon"]) if obj.get("dataleon") is not None else None,
            "veryfi": PydanticMainOcrfinancialParserFinancialParserDataClass94559368405584.from_dict(obj["veryfi"]) if obj.get("veryfi") is not None else None,
            "base64": PydanticMainOcrfinancialParserFinancialParserDataClass94559368274592.from_dict(obj["base64"]) if obj.get("base64") is not None else None
        })
        return _obj
