...
class OcrocrAsyncModel(BaseModel):
    ...
    OcrocrAsyncModel
    """ # noqa: E501
    oneai: Optional[PydanticMainOcrocrAsyncOcrAsyncDataClass94559367722320] = None
    amazon: Optional[PydanticMainOcrocrAsyncOcrAsyncDataClass94559367877312] = None
    microsoft: Optional[PydanticMainOcrocrAsyncOcrAsyncDataClass94559367896608] = None
    google: Optional[PydanticMainOcrocrAsyncOcrAsyncDataClass94559367893264] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "oneai": PydanticMainOcrocrAsyncOcrAsyncDataClass94559367722320.from_dict(obj["oneai"]) if obj.get("oneai") is not None else None,
            "amazon": PydanticMainOcrocrAsyncOcrAsyncDataClass94559367877312.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "microsoft": PydanticMainOcrocrAsyncOcrAsyncDataClass94559367896608.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": PydanticMainOcrocrAsyncOcrAsyncDataClass94559367893264.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
