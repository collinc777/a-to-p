...
class OcrocrTablesAsyncModel(BaseModel):
    ...
    """ # noqa: E501
    amazon: Optional[PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364090368] = None
    microsoft: Optional[PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364153120] = None
    google: Optional[PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364126080] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amazon": PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364090368.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "microsoft": PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364153120.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364126080.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
