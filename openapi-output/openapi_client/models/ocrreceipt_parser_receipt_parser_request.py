...
class OcrreceiptParserReceiptParserRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "file", "file_url", "file_password", "language", "convert_to_pdf"]
