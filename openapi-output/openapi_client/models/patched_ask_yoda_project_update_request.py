...
class PatchedAskYodaProjectUpdateRequest(BaseModel):
    ...
    speech_to_text_provider: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["ocr_provider", "speech_to_text_provider", "llm_provider", "llm_model", "chunk_size", "chunk_separators"]
