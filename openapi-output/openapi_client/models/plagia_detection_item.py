...
class PlagiaDetectionItem(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr
    candidates: Optional[List[PlagiaDetectionCandidate]] = None
    __properties: ClassVar[List[str]] = ["text", "candidates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "candidates": [PlagiaDetectionCandidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None
        })
        return _obj
