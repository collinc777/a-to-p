...
class PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364511728(BaseModel):
    """
    PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364511728
    """ # noqa: E501
    audio: StrictStr
    voice_type: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["audio", "voice_type", "audio_resource_url", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audio": obj.get("audio"),
            "voice_type": obj.get("voice_type"),
            "audio_resource_url": obj.get("audio_resource_url"),
