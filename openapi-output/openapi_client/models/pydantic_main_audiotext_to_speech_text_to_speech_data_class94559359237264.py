...
class PydanticMainAudiotextToSpeechTextToSpeechDataClass94559359237264(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["audio", "voice_type", "audio_resource_url", "original_response", "status"]
