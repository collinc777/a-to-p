...
class PydanticMainImagebackgroundRemovalBackgroundRemovalDataClass94559363754992(BaseModel):
    """
    PydanticMainImagebackgroundRemovalBackgroundRemovalDataClass94559363754992
    """ # noqa: E501
    image_b64: StrictStr = Field(description="The image in base64 format.")
    image_resource_url: StrictStr = Field(description="The image url.")
    ...
    __properties: ClassVar[List[str]] = ["image_b64", "image_resource_url", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image_resource_url": obj.get("image_resource_url"),
