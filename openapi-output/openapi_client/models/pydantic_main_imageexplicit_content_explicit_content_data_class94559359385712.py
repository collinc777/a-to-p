...
class PydanticMainImageexplicitContentExplicitContentDataClass94559359385712(BaseModel):
    """
    PydanticMainImageexplicitContentExplicitContentDataClass94559359385712
    """ # noqa: E501
    nsfw_likelihood: StrictInt
    nsfw_likelihood_score: StrictInt
    items: Optional[List[ExplicitItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["nsfw_likelihood", "nsfw_likelihood_score", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nsfw_likelihood": obj.get("nsfw_likelihood"),
            "nsfw_likelihood_score": obj.get("nsfw_likelihood_score"),
            "items": [ExplicitItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
