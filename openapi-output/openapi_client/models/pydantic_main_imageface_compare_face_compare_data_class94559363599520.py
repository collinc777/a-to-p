...
class PydanticMainImagefaceCompareFaceCompareDataClass94559363599520(BaseModel):
    """
    PydanticMainImagefaceCompareFaceCompareDataClass94559363599520
    """ # noqa: E501
    items: Optional[List[FaceMatch]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FaceMatch.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
