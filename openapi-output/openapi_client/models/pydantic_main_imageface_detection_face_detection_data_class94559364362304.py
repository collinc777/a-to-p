...
class PydanticMainImagefaceDetectionFaceDetectionDataClass94559364362304(BaseModel):
    """
    PydanticMainImagefaceDetectionFaceDetectionDataClass94559364362304
    """ # noqa: E501
    items: Optional[List[FaceItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FaceItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
