...
class PydanticMainImagefaceRecognitionFaceRecognitionAddFaceDataClass94559363586448(BaseModel):
    """
    PydanticMainImagefaceRecognitionFaceRecognitionAddFaceDataClass94559363586448
    """ # noqa: E501
    face_ids: List[StrictStr]
    ...
    __properties: ClassVar[List[str]] = ["face_ids", "original_response", "status"]
