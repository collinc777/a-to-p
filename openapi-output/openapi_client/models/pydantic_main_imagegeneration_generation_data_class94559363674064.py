...
class PydanticMainImagegenerationGenerationDataClass94559363674064(BaseModel):
    """
    PydanticMainImagegenerationGenerationDataClass94559363674064
    """ # noqa: E501
    items: Optional[List[GeneratedImageDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [GeneratedImageDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
