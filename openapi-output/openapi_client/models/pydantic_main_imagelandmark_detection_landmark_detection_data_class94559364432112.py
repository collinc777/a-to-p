...
class PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559364432112(BaseModel):
    """
    PydanticMainImagelandmarkDetectionLandmarkDetectionDataClass94559364432112
    """ # noqa: E501
    items: Optional[List[LandmarkItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [LandmarkItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
