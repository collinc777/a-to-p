...
class PydanticMainImagelogoDetectionLogoDetectionDataClass94559363427872(BaseModel):
    """
    PydanticMainImagelogoDetectionLogoDetectionDataClass94559363427872
    """ # noqa: E501
    items: Optional[List[LogoItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [LogoItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
