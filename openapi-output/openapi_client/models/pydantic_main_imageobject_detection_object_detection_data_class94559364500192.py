...
class PydanticMainImageobjectDetectionObjectDetectionDataClass94559364500192(BaseModel):
    """
    PydanticMainImageobjectDetectionObjectDetectionDataClass94559364500192
    """ # noqa: E501
    items: Optional[List[ObjectItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ObjectItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
