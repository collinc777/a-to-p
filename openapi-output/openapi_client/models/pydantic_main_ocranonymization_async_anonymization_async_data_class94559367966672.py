...
class PydanticMainOcranonymizationAsyncAnonymizationAsyncDataClass94559367966672(BaseModel):
    """
    PydanticMainOcranonymizationAsyncAnonymizationAsyncDataClass94559367966672
    """ # noqa: E501
    document: StrictStr
    document_url: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["document", "document_url", "original_response", "id", "final_status", "error"]
