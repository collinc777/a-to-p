...
class PydanticMainOcrbankCheckParsingBankCheckParsingDataClass94559363843808(BaseModel):
    """
    PydanticMainOcrbankCheckParsingBankCheckParsingDataClass94559363843808
    """ # noqa: E501
    extracted_data: Optional[List[ItemBankCheckParsingDataClass]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PydanticMainOcrbankCheckParsingBankCheckParsingDataClass94559363843808 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PydanticMainOcrbankCheckParsingBankCheckParsingDataClass94559363843808 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "extracted_data": [ItemBankCheckParsingDataClass.from_dict(_item) for _item in obj["extracted_data"]] if obj.get("extracted_data") is not None else None,
