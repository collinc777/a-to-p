...
class PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367856608(BaseModel):
    """
    PydanticMainOcrcustomDocumentParsingAsyncCustomDocumentParsingAsyncDataClass94559367856608
    """ # noqa: E501
    items: Optional[List[CustomDocumentParsingAsyncItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["items", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [CustomDocumentParsingAsyncItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
