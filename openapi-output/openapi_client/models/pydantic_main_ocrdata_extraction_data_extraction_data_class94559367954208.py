...
class PydanticMainOcrdataExtractionDataExtractionDataClass94559367954208(BaseModel):
    """
    PydanticMainOcrdataExtractionDataExtractionDataClass94559367954208
    """ # noqa: E501
    fields: Optional[List[ItemDataExtraction]] = None
    ...
    __properties: ClassVar[List[str]] = ["fields", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [ItemDataExtraction.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
