...
class PydanticMainOcridentityParserIdentityParserDataClass94559367751728(BaseModel):
    """
    PydanticMainOcridentityParserIdentityParserDataClass94559367751728
    """ # noqa: E501
    extracted_data: Optional[List[InfosIdentityParserDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extracted_data": [InfosIdentityParserDataClass.from_dict(_item) for _item in obj["extracted_data"]] if obj.get("extracted_data") is not None else None,
