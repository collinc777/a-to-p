...
class PydanticMainOcrinvoiceParserInvoiceParserDataClass94559363989968(BaseModel):
    """
    PydanticMainOcrinvoiceParserInvoiceParserDataClass94559363989968
    """ # noqa: E501
    extracted_data: Optional[List[InfosInvoiceParserDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extracted_data": [InfosInvoiceParserDataClass.from_dict(_item) for _item in obj["extracted_data"]] if obj.get("extracted_data") is not None else None,
