...
class PydanticMainOcrocrOcrDataClass94559363872064(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["text", "bounding_boxes", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "bounding_boxes": [BoundingBox.from_dict(_item) for _item in obj["bounding_boxes"]] if obj.get("bounding_boxes") is not None else None,
