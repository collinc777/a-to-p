...
class PydanticMainOcrocrTablesAsyncOcrTablesAsyncDataClass94559364090368(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pages", "num_pages", "original_response", "id", "final_status", "error"]
