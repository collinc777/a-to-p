...
class PydanticMainOcrreceiptParserReceiptParserDataClass94559367696976(BaseModel):
    """
    PydanticMainOcrreceiptParserReceiptParserDataClass94559367696976
    """ # noqa: E501
    extracted_data: Optional[List[InfosReceiptParserDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "extracted_data": [InfosReceiptParserDataClass.from_dict(_item) for _item in obj["extracted_data"]] if obj.get("extracted_data") is not None else None,
