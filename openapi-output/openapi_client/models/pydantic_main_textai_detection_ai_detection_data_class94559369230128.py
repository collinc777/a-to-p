...
class PydanticMainTextaiDetectionAiDetectionDataClass94559369230128(BaseModel):
    """
    PydanticMainTextaiDetectionAiDetectionDataClass94559369230128
    """ # noqa: E501
    ai_score: StrictInt
    items: Optional[List[AiDetectionItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["ai_score", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [AiDetectionItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
