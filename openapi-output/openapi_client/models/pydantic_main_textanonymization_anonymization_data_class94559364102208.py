...
class PydanticMainTextanonymizationAnonymizationDataClass94559364102208(BaseModel):
    """
    PydanticMainTextanonymizationAnonymizationDataClass94559364102208
    """ # noqa: E501
    result: StrictStr
    entities: Optional[List[AnonymizationEntity]] = None
    ...
    __properties: ClassVar[List[str]] = ["result", "entities", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": [AnonymizationEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
