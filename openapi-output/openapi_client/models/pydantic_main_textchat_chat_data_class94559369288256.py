...
class PydanticMainTextchatChatDataClass94559369288256(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["generated_text", "message", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": [ChatMessageDataClass.from_dict(_item) for _item in obj["message"]] if obj.get("message") is not None else None,
