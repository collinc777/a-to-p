...
class PydanticMainTextcodeGenerationCodeGenerationDataClass94559369103024(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["generated_text", "original_response", "status"]
