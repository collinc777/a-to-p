...
class PydanticMainTextcustomClassificationCustomClassificationDataClass94559369146736(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["classifications", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classifications": [ItemCustomClassificationDataClass.from_dict(_item) for _item in obj["classifications"]] if obj.get("classifications") is not None else None,
