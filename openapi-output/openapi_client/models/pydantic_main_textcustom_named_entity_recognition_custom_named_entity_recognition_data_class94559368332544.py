...
class PydanticMainTextcustomNamedEntityRecognitionCustomNamedEntityRecognitionDataClass94559368332544(BaseModel):
    """
    PydanticMainTextcustomNamedEntityRecognitionCustomNamedEntityRecognitionDataClass94559368332544
    """ # noqa: E501
    items: Optional[List[InfosCustomNamedEntityRecognitionDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InfosCustomNamedEntityRecognitionDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
