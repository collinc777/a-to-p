...
class PydanticMainTextembeddingsEmbeddingsDataClass94559369220000(BaseModel):
    """
    PydanticMainTextembeddingsEmbeddingsDataClass94559369220000
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [EmbeddingDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
