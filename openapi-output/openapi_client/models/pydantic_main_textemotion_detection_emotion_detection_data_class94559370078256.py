...
class PydanticMainTextemotionDetectionEmotionDetectionDataClass94559370078256(BaseModel):
    """
    PydanticMainTextemotionDetectionEmotionDetectionDataClass94559370078256
    """ # noqa: E501
    text: StrictStr
    items: Optional[List[EmotionItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["text", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "items": [EmotionItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
