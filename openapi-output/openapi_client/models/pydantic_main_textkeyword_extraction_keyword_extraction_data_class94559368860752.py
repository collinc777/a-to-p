...
class PydanticMainTextkeywordExtractionKeywordExtractionDataClass94559368860752(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InfosKeywordExtractionDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
