...
class PydanticMainTextmoderationModerationDataClass94559368980912(BaseModel):
    """
    PydanticMainTextmoderationModerationDataClass94559368980912
    """ # noqa: E501
    nsfw_likelihood: StrictInt
    items: Optional[List[TextModerationItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["nsfw_likelihood", "items", "nsfw_likelihood_score", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [TextModerationItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
