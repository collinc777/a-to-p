...
class PydanticMainTextplagiaDetectionPlagiaDetectionDataClass94559369357120(BaseModel):
    """
    PydanticMainTextplagiaDetectionPlagiaDetectionDataClass94559369357120
    """ # noqa: E501
    plagia_score: StrictInt
    items: Optional[List[PlagiaDetectionItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["plagia_score", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plagia_score": obj.get("plagia_score"),
            "items": [PlagiaDetectionItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
