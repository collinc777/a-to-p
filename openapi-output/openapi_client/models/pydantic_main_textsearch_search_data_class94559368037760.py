...
class PydanticMainTextsearchSearchDataClass94559368037760(BaseModel):
    """
    PydanticMainTextsearchSearchDataClass94559368037760
    """ # noqa: E501
    items: Optional[List[InfosSearchDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InfosSearchDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
