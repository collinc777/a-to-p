...
class PydanticMainTextspellCheckSpellCheckDataClass94559369164672(BaseModel):
    """
    PydanticMainTextspellCheckSpellCheckDataClass94559369164672
    """ # noqa: E501
    text: StrictStr
    items: Optional[List[SpellCheckItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "items": [SpellCheckItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
