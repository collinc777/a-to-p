...
class PydanticMainTexttopicExtractionTopicExtractionDataClass94559368087456(BaseModel):
    """
    PydanticMainTexttopicExtractionTopicExtractionDataClass94559368087456
    """ # noqa: E501
    items: Optional[List[ExtractedTopic]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ExtractedTopic.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
