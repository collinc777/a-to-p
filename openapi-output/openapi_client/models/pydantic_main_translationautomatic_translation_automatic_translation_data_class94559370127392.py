...
class PydanticMainTranslationautomaticTranslationAutomaticTranslationDataClass94559370127392(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["text", "original_response", "status"]
