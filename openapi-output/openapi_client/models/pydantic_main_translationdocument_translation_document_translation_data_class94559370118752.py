...
class PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370118752(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["file", "document_resource_url", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file": obj.get("file"),
            "document_resource_url": obj.get("document_resource_url"),
