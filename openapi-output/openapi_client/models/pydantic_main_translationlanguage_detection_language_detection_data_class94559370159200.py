...
class PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370159200(BaseModel):
    """
    PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370159200
    """ # noqa: E501
    items: Optional[List[InfosLanguageDetectionDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [InfosLanguageDetectionDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
