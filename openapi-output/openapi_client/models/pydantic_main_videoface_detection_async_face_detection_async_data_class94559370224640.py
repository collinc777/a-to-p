...
class PydanticMainVideofaceDetectionAsyncFaceDetectionAsyncDataClass94559370224640(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["faces", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "faces": [VideoFace.from_dict(_item) for _item in obj["faces"]] if obj.get("faces") is not None else None,
