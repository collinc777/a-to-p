...
class PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370235904(BaseModel):
    """
    PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370235904
    """ # noqa: E501
    labels: Optional[List[VideoLabel]] = None
    ...
    __properties: ClassVar[List[str]] = ["labels", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labels": [VideoLabel.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
