...
class PydanticMainVideologoDetectionAsyncLogoDetectionAsyncDataClass94559370802928(BaseModel):
    """
    PydanticMainVideologoDetectionAsyncLogoDetectionAsyncDataClass94559370802928
    """ # noqa: E501
    logos: Optional[List[LogoTrack]] = None
    ...
    __properties: ClassVar[List[str]] = ["logos", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logos": [LogoTrack.from_dict(_item) for _item in obj["logos"]] if obj.get("logos") is not None else None,
