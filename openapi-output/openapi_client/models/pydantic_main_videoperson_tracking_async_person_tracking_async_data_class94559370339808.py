...
class PydanticMainVideopersonTrackingAsyncPersonTrackingAsyncDataClass94559370339808(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["persons", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "persons": [VideoTrackingPerson.from_dict(_item) for _item in obj["persons"]] if obj.get("persons") is not None else None,
