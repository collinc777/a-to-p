...
class PydanticMainVideotextDetectionAsyncTextDetectionAsyncDataClass94559370222656(BaseModel):
    """
    PydanticMainVideotextDetectionAsyncTextDetectionAsyncDataClass94559370222656
    """ # noqa: E501
    texts: Optional[List[VideoText]] = None
    ...
    __properties: ClassVar[List[str]] = ["texts", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "texts": [VideoText.from_dict(_item) for _item in obj["texts"]] if obj.get("texts") is not None else None,
