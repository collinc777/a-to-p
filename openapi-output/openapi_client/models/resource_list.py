...
class ResourceList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resource", "data", "type", "provider", "assets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assets": [AssetList.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
