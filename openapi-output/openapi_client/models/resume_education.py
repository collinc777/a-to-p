...
class ResumeEducation(BaseModel):
    ...
    ResumeEducation
    """ # noqa: E501
    total_years_education: StrictInt
    entries: Optional[List[ResumeEducationEntry]] = None
    __properties: ClassVar[List[str]] = ["total_years_education", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_years_education": obj.get("total_years_education"),
            "entries": [ResumeEducationEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
