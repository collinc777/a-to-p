...
class ResumeExtractedData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["personal_infos", "education", "work_experience", "languages", "skills", "certifications", "courses", "publications", "interests"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "personal_infos": ResumePersonalInfo.from_dict(obj["personal_infos"]) if obj.get("personal_infos") is not None else None,
            "education": ResumeEducation.from_dict(obj["education"]) if obj.get("education") is not None else None,
            "work_experience": ResumeWorkExp.from_dict(obj["work_experience"]) if obj.get("work_experience") is not None else None,
            "languages": [ResumeLang.from_dict(_item) for _item in obj["languages"]] if obj.get("languages") is not None else None,
            "skills": [ResumeSkill.from_dict(_item) for _item in obj["skills"]] if obj.get("skills") is not None else None,
            "certifications": [ResumeSkill.from_dict(_item) for _item in obj["certifications"]] if obj.get("certifications") is not None else None,
            "courses": [ResumeSkill.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None,
            "publications": [ResumeSkill.from_dict(_item) for _item in obj["publications"]] if obj.get("publications") is not None else None,
            "interests": [ResumeSkill.from_dict(_item) for _item in obj["interests"]] if obj.get("interests") is not None else None
        })
        return _obj
