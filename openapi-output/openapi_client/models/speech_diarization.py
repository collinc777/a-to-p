...
class SpeechDiarization(BaseModel):
    ...
    SpeechDiarization
    """ # noqa: E501
    total_speakers: StrictInt
    entries: Optional[List[SpeechDiarizationEntry]] = None
    error_message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["total_speakers", "entries", "error_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total_speakers": obj.get("total_speakers"),
            "entries": [SpeechDiarizationEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
