...
class TextaiDetectionAiDetectionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "text", "language", "provider_params"]
