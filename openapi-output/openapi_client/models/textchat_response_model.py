...
class TextchatResponseModel(BaseModel):
    ...
    """ # noqa: E501
    meta: Optional[PydanticMainTextchatChatDataClass94559369249760] = None
    google: Optional[PydanticMainTextchatChatDataClass94559367720304] = None
    cohere: Optional[PydanticMainTextchatChatDataClass94559369255280] = None
    mistral: Optional[PydanticMainTextchatChatDataClass94559369272176] = None
    replicate: Optional[PydanticMainTextchatChatDataClass94559369275344] = None
    perplexityai: Optional[PydanticMainTextchatChatDataClass94559369279648] = None
    openai: Optional[PydanticMainTextchatChatDataClass94559369283952] = None
    anthropic: Optional[PydanticMainTextchatChatDataClass94559369288256] = None
    __properties: ClassVar[List[str]] = ["meta", "google", "cohere", "mistral", "replicate", "perplexityai", "openai", "anthropic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": PydanticMainTextchatChatDataClass94559369249760.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "google": PydanticMainTextchatChatDataClass94559367720304.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "cohere": PydanticMainTextchatChatDataClass94559369255280.from_dict(obj["cohere"]) if obj.get("cohere") is not None else None,
            "mistral": PydanticMainTextchatChatDataClass94559369272176.from_dict(obj["mistral"]) if obj.get("mistral") is not None else None,
            "replicate": PydanticMainTextchatChatDataClass94559369275344.from_dict(obj["replicate"]) if obj.get("replicate") is not None else None,
            "perplexityai": PydanticMainTextchatChatDataClass94559369279648.from_dict(obj["perplexityai"]) if obj.get("perplexityai") is not None else None,
            "openai": PydanticMainTextchatChatDataClass94559369283952.from_dict(obj["openai"]) if obj.get("openai") is not None else None,
            "anthropic": PydanticMainTextchatChatDataClass94559369288256.from_dict(obj["anthropic"]) if obj.get("anthropic") is not None else None
        })
        return _obj
