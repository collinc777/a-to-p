...
class TextcustomClassificationCustomClassificationRequest(BaseModel):
    """
    ...
    texts: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="List of texts to classify")
    labels: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="List of the labels (classes) you want the texts to be classified as.")
    examples: List[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=2, max_length=2)]] = Field(description="List of text/label pairs (eg: [['I need help please wire me $1000 right now', 'spam'],]")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "texts", "labels", "examples"]
