...
class TextcustomClassificationResponseModel(BaseModel):
    ...
    """ # noqa: E501
    cohere: Optional[PydanticMainTextcustomClassificationCustomClassificationDataClass94559369166832] = None
    openai: Optional[PydanticMainTextcustomClassificationCustomClassificationDataClass94559369146736] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cohere": PydanticMainTextcustomClassificationCustomClassificationDataClass94559369166832.from_dict(obj["cohere"]) if obj.get("cohere") is not None else None,
            "openai": PydanticMainTextcustomClassificationCustomClassificationDataClass94559369146736.from_dict(obj["openai"]) if obj.get("openai") is not None else None
        })
        return _obj
