...
class TextcustomNamedEntityRecognitionCustomNamedEntityRecognitionRequest(BaseModel):
    """
    ...
    text: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Enter your input text.")
    entities: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=2)] = Field(description="List of entities (at least two) to extract from your text eg : ['job', 'country'].")
    examples: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of examples eg : [{'text': 'an input text', 'entities' : [{'entity':'entity_1', 'category':'category_1'}, ...]}, ...]")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "text", "entities", "examples"]
