...
class TextembeddingsEmbeddingsRequest(BaseModel):
    ...
    texts: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="List of texts to transform into embeddings.")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "settings", "texts"]
