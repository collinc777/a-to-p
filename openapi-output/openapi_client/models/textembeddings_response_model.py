...
class TextembeddingsResponseModel(BaseModel):
    ...
    """ # noqa: E501
    jina: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369367824] = None
    google: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369234112] = None
    cohere: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369235600] = None
    mistral: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369215696] = None
    ai21labs: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369220000] = None
    openai: Optional[PydanticMainTextembeddingsEmbeddingsDataClass94559369224304] = None
    __properties: ClassVar[List[str]] = ["jina", "google", "cohere", "mistral", "ai21labs", "openai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jina": PydanticMainTextembeddingsEmbeddingsDataClass94559369367824.from_dict(obj["jina"]) if obj.get("jina") is not None else None,
            "google": PydanticMainTextembeddingsEmbeddingsDataClass94559369234112.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "cohere": PydanticMainTextembeddingsEmbeddingsDataClass94559369235600.from_dict(obj["cohere"]) if obj.get("cohere") is not None else None,
            "mistral": PydanticMainTextembeddingsEmbeddingsDataClass94559369215696.from_dict(obj["mistral"]) if obj.get("mistral") is not None else None,
            "ai21labs": PydanticMainTextembeddingsEmbeddingsDataClass94559369220000.from_dict(obj["ai21labs"]) if obj.get("ai21labs") is not None else None,
            "openai": PydanticMainTextembeddingsEmbeddingsDataClass94559369224304.from_dict(obj["openai"]) if obj.get("openai") is not None else None
        })
        return _obj
