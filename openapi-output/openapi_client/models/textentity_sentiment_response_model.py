...
class TextentitySentimentResponseModel(BaseModel):
    ...
    """ # noqa: E501
    amazon: Optional[PydanticMainTextentitySentimentEntitySentimentDataClass94559369338896] = None
    google: Optional[PydanticMainTextentitySentimentEntitySentimentDataClass94559369339840] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amazon": PydanticMainTextentitySentimentEntitySentimentDataClass94559369338896.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "google": PydanticMainTextentitySentimentEntitySentimentDataClass94559369339840.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
