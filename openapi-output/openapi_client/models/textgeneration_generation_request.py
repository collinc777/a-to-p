...
class TextgenerationGenerationRequest(BaseModel):
    """
    ...
    text: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Enter your prompt")
    ...
    max_tokens: Optional[Annotated[int, Field(le=4048, strict=True, ge=1)]] = Field(default=1000, description="The maximum number of tokens to generate in the completion. The token count of your prompt plus max_tokens cannot exceed the model's context length.")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "settings", "text", "temperature", "max_tokens"]
