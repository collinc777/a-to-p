...
class TextgenerationResponseModel(BaseModel):
    ...
    """ # noqa: E501
    meta: Optional[PydanticMainTextgenerationGenerationDataClass94559368042544] = None
    google: Optional[PydanticMainTextgenerationGenerationDataClass94559369063440] = None
    cohere: Optional[PydanticMainTextgenerationGenerationDataClass94559369064384] = None
    mistral: Optional[PydanticMainTextgenerationGenerationDataClass94559369052128] = None
    amazon: Optional[PydanticMainTextgenerationGenerationDataClass94559369056400] = None
    ai21labs: Optional[PydanticMainTextgenerationGenerationDataClass94559369067424] = None
    clarifai: Optional[PydanticMainTextgenerationGenerationDataClass94559369068368] = None
    openai: Optional[PydanticMainTextgenerationGenerationDataClass94559369074208] = None
    anthropic: Optional[PydanticMainTextgenerationGenerationDataClass94559369075152] = None
    __properties: ClassVar[List[str]] = ["meta", "google", "cohere", "mistral", "amazon", "ai21labs", "clarifai", "openai", "anthropic"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": PydanticMainTextgenerationGenerationDataClass94559368042544.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "google": PydanticMainTextgenerationGenerationDataClass94559369063440.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "cohere": PydanticMainTextgenerationGenerationDataClass94559369064384.from_dict(obj["cohere"]) if obj.get("cohere") is not None else None,
            "mistral": PydanticMainTextgenerationGenerationDataClass94559369052128.from_dict(obj["mistral"]) if obj.get("mistral") is not None else None,
            "amazon": PydanticMainTextgenerationGenerationDataClass94559369056400.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "ai21labs": PydanticMainTextgenerationGenerationDataClass94559369067424.from_dict(obj["ai21labs"]) if obj.get("ai21labs") is not None else None,
            "clarifai": PydanticMainTextgenerationGenerationDataClass94559369068368.from_dict(obj["clarifai"]) if obj.get("clarifai") is not None else None,
            "openai": PydanticMainTextgenerationGenerationDataClass94559369074208.from_dict(obj["openai"]) if obj.get("openai") is not None else None,
            "anthropic": PydanticMainTextgenerationGenerationDataClass94559369075152.from_dict(obj["anthropic"]) if obj.get("anthropic") is not None else None
        })
        return _obj
