...
class TextmoderationResponseModel(BaseModel):
    ...
    """ # noqa: E501
    openai: Optional[PydanticMainTextmoderationModerationDataClass94559368951360] = None
    microsoft: Optional[PydanticMainTextmoderationModerationDataClass94559368980912] = None
    clarifai: Optional[PydanticMainTextmoderationModerationDataClass94559368971952] = None
    google: Optional[PydanticMainTextmoderationModerationDataClass94559368916096] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "openai": PydanticMainTextmoderationModerationDataClass94559368951360.from_dict(obj["openai"]) if obj.get("openai") is not None else None,
            "microsoft": PydanticMainTextmoderationModerationDataClass94559368980912.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "clarifai": PydanticMainTextmoderationModerationDataClass94559368971952.from_dict(obj["clarifai"]) if obj.get("clarifai") is not None else None,
            "google": PydanticMainTextmoderationModerationDataClass94559368916096.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
