...
class TextplagiaDetectionPlagiaDetectionRequest(BaseModel):
    """
    ...
    text: Annotated[str, Field(min_length=1, strict=True)] = Field(description="A text content on which a plagiarism detection analysis will be run")
    title: Optional[StrictStr] = Field(default='', description="Content title")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "text", "title"]
