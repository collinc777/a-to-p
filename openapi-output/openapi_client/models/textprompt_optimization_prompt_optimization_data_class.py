...
class TextpromptOptimizationPromptOptimizationDataClass(BaseModel):
    """
    TextpromptOptimizationPromptOptimizationDataClass
    """ # noqa: E501
    missing_information: StrictStr
    items: Optional[List[PromptDataClass]] = None
    ...
    __properties: ClassVar[List[str]] = ["missing_information", "items", "original_response", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [PromptDataClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
