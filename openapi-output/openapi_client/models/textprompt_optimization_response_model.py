...
class TextpromptOptimizationResponseModel(BaseModel):
    """
    TextpromptOptimizationResponseModel
    """ # noqa: E501
    openai: Optional[TextpromptOptimizationPromptOptimizationDataClass] = None
    __properties: ClassVar[List[str]] = ["openai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "openai": TextpromptOptimizationPromptOptimizationDataClass.from_dict(obj["openai"]) if obj.get("openai") is not None else None
        })
        return _obj
