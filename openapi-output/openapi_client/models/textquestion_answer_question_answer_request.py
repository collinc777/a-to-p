...
class TextquestionAnswerQuestionAnswerRequest(BaseModel):
    """
    ...
    texts: List[Annotated[str, Field(min_length=1, strict=True)]] = Field(description="List of texts to analyze")
    question: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Question about the text content")
    temperature: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=0.0, description="Higher values mean the model will take more risks and value 0 (argmax sampling) works better for scenarios with a well-defined answer.")
    examples_context: Annotated[str, Field(min_length=1, strict=True)] = Field(description="example text serving as context")
    examples: List[Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=2, max_length=2)]] = Field(description="List of question/answer pairs (eg: [['When was Barack Obama elected president?', 'in 2009.'],]")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "texts", "question", "temperature", "examples_context", "examples"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "examples_context": obj.get("examples_context"),
