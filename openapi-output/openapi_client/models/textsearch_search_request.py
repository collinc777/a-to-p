...
class TextsearchSearchRequest(BaseModel):
    """
    ...
    texts: Annotated[List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=2)] = Field(description="A list of texts to search in.")
    query: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Your text query.")
    similarity_metric: Optional[SimilarityMetricEnum] = Field(default=None, description="Is used to specify the similarity function that calculates the similarity between embedding vectors when performing text searches. This parameter allows you to customize how text similarity is measured, which can be crucial in various natural language processing tasks such as document retrieval, recommendation systems, and clustering.  * `cosine` - cosine * `manhattan` - manhattan * `euclidean` - euclidean")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "texts", "query", "similarity_metric"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "texts": obj.get("texts"),
            "query": obj.get("query"),
            "similarity_metric": obj.get("similarity_metric")
        })
        return _obj
