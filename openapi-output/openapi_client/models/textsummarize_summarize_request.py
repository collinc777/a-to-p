...
class TextsummarizeSummarizeRequest(BaseModel):
    """
    ...
    language: Optional[StrictStr] = Field(default=None, description="Language code for the language the input text is written in (eg: en, fr).")
    ...
    output_sentences: Optional[Annotated[int, Field(strict=True, ge=1)]] = 1
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "text", "language", "settings", "output_sentences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "output_sentences": obj.get("output_sentences") if obj.get("output_sentences") is not None else 1
        })
        return _obj
