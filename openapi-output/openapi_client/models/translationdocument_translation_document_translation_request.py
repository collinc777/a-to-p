...
class TranslationdocumentTranslationDocumentTranslationRequest(BaseModel):
    """
    ...
    source_language: Optional[StrictStr] = Field(default=None, description="Source language code (ex: en, fr)")
    target_language: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Target language code (ex: en, fr)")
    __properties: ClassVar[List[str]] = ["providers", "fallback_providers", "response_as_dict", "attributes_as_list", "show_original_response", "file", "file_url", "file_password", "source_language", "target_language"]
