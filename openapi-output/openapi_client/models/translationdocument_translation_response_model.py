...
class TranslationdocumentTranslationResponseModel(BaseModel):
    """
    TranslationdocumentTranslationResponseModel
    """ # noqa: E501
    google: Optional[PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370118752] = None
    deepl: Optional[PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370119696] = None
    __properties: ClassVar[List[str]] = ["google", "deepl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "google": PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370118752.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "deepl": PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370119696.from_dict(obj["deepl"]) if obj.get("deepl") is not None else None
        })
        return _obj
