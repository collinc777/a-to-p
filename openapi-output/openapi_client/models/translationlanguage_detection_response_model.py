...
class TranslationlanguageDetectionResponseModel(BaseModel):
    ...
    """ # noqa: E501
    microsoft: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369336432] = None
    ibm: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369337376] = None
    google: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370067792] = None
    oneai: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370068736] = None
    amazon: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369332272] = None
    neuralspace: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369333216] = None
    modernmt: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370153472] = None
    openai: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370159200] = None
    eden_ai: Optional[PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370164704] = Field(default=None, alias="eden-ai")
    __properties: ClassVar[List[str]] = ["microsoft", "ibm", "google", "oneai", "amazon", "neuralspace", "modernmt", "openai", "eden-ai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "microsoft": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369336432.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "ibm": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369337376.from_dict(obj["ibm"]) if obj.get("ibm") is not None else None,
            "google": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370067792.from_dict(obj["google"]) if obj.get("google") is not None else None,
            "oneai": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370068736.from_dict(obj["oneai"]) if obj.get("oneai") is not None else None,
            "amazon": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369332272.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "neuralspace": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559369333216.from_dict(obj["neuralspace"]) if obj.get("neuralspace") is not None else None,
            "modernmt": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370153472.from_dict(obj["modernmt"]) if obj.get("modernmt") is not None else None,
            "openai": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370159200.from_dict(obj["openai"]) if obj.get("openai") is not None else None,
            "eden-ai": PydanticMainTranslationlanguageDetectionLanguageDetectionDataClass94559370164704.from_dict(obj["eden-ai"]) if obj.get("eden-ai") is not None else None
        })
        return _obj
