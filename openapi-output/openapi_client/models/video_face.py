...
class VideoFace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["offset", "bounding_box", "attributes", "landmarks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bounding_box": VideoBoundingBox.from_dict(obj["bounding_box"]) if obj.get("bounding_box") is not None else None,
            "attributes": FaceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "landmarks": LandmarksVideo.from_dict(obj["landmarks"]) if obj.get("landmarks") is not None else None
        })
        return _obj
