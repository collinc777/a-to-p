...
class VideoLogo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["timestamp", "bounding_box", "confidence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bounding_box": VideoLogoBoundingBox.from_dict(obj["bounding_box"]) if obj.get("bounding_box") is not None else None,
