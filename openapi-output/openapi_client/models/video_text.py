...
class VideoText(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr
    frames: Optional[List[VideoTextFrames]] = None
    __properties: ClassVar[List[str]] = ["text", "frames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "frames": [VideoTextFrames.from_dict(_item) for _item in obj["frames"]] if obj.get("frames") is not None else None
        })
        return _obj
