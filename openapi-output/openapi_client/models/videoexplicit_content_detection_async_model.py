...
class VideoexplicitContentDetectionAsyncModel(BaseModel):
    ...
    """ # noqa: E501
    amazon: Optional[PydanticMainVideoexplicitContentDetectionAsyncExplicitContentDetectionAsyncDataClass94559370781680] = None
    google: Optional[PydanticMainVideoexplicitContentDetectionAsyncExplicitContentDetectionAsyncDataClass94559370768592] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amazon": PydanticMainVideoexplicitContentDetectionAsyncExplicitContentDetectionAsyncDataClass94559370781680.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "google": PydanticMainVideoexplicitContentDetectionAsyncExplicitContentDetectionAsyncDataClass94559370768592.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
