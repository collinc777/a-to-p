...
class VideofaceDetectionAsyncModel(BaseModel):
    ...
    """ # noqa: E501
    amazon: Optional[PydanticMainVideofaceDetectionAsyncFaceDetectionAsyncDataClass94559370300320] = None
    google: Optional[PydanticMainVideofaceDetectionAsyncFaceDetectionAsyncDataClass94559370224640] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amazon": PydanticMainVideofaceDetectionAsyncFaceDetectionAsyncDataClass94559370300320.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "google": PydanticMainVideofaceDetectionAsyncFaceDetectionAsyncDataClass94559370224640.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
