...
class VideolabelDetectionAsyncModel(BaseModel):
    ...
    """ # noqa: E501
    amazon: Optional[PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370202064] = None
    google: Optional[PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370235904] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amazon": PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370202064.from_dict(obj["amazon"]) if obj.get("amazon") is not None else None,
            "google": PydanticMainVideolabelDetectionAsyncLabelDetectionAsyncDataClass94559370235904.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
