...
class VideoobjectTrackingAsyncObjectTrackingAsyncDataClass(BaseModel):
    """
    VideoobjectTrackingAsyncObjectTrackingAsyncDataClass
    """ # noqa: E501
    objects: Optional[List[ObjectTrack]] = None
    ...
    __properties: ClassVar[List[str]] = ["objects", "original_response", "id", "final_status", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [ObjectTrack.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
