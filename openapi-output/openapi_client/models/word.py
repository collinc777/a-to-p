...
class Word(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr = Field(description="Text detected in the word")
    bounding_box: BoundingBox = Field(description="Bounding boxes of the words in the word")
    confidence: StrictInt = Field(description="Confidence score of the word")
    __properties: ClassVar[List[str]] = ["text", "bounding_box", "confidence"]
