...
class YodaInfoResponse(BaseModel):
    """
    YodaInfoResponse
    """ # noqa: E501
    db_provider: StrictStr
    embeddings_provider: StrictStr
    llm_provider: StrictStr
    llm_model: StrictStr
    collection_size: StrictInt
    __properties: ClassVar[List[str]] = ["db_provider", "embeddings_provider", "llm_provider", "llm_model", "collection_size"]
