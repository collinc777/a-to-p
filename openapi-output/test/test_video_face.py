...
class TestVideoFace(unittest.TestCase):
    """VideoFace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoFace:
        """Test VideoFace
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoFace`
        """
        model = VideoFace()
        if include_optional:
            return VideoFace(
