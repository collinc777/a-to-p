...
json = "{}"
# create an instance of AsyncOcrRequest from a JSON string
async_ocr_request_instance = AsyncOcrRequest.from_json(json)
# print the JSON string representation of the object
print(AsyncOcrRequest.to_json())

# convert the object into a dict
async_ocr_request_dict = async_ocr_request_instance.to_dict()
# create an instance of AsyncOcrRequest from a dict
async_ocr_request_form_dict = async_ocr_request.from_dict(async_ocr_request_dict)
```
