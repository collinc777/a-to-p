...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content Detection Launch Job
        api_response = api_instance.video_video_explicit_content_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content delete Jobs
        api_instance.video_video_explicit_content_detection_async_destroy()
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content Detection List Jobs
        api_response = api_instance.video_video_explicit_content_detection_async_retrieve()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Explicit Content Detection Get Job Results
        api_response = api_instance.video_video_explicit_content_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
