...
json = "{}"
# create an instance of ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest from a JSON string
imageautoml_classificationdelete_project_automl_classification_delete_request_instance = ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest.from_json(json)
# print the JSON string representation of the object
print(ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest.to_json())

# convert the object into a dict
imageautoml_classificationdelete_project_automl_classification_delete_request_dict = imageautoml_classificationdelete_project_automl_classification_delete_request_instance.to_dict()
# create an instance of ImageautomlClassificationdeleteProjectAutomlClassificationDeleteRequest from a dict
imageautoml_classificationdelete_project_automl_classification_delete_request_form_dict = imageautoml_classificationdelete_project_automl_classification_delete_request.from_dict(imageautoml_classificationdelete_project_automl_classification_delete_request_dict)
```
