...
**representation** | [**RepresentationEnum**](RepresentationEnum.md) | The type of embedding representation to embed the image with  * &#x60;document&#x60; - document * &#x60;query&#x60; - query * &#x60;symetric&#x60; - symetric | 
...
json = "{}"
# create an instance of ImageembeddingsEmbeddingsRequest from a JSON string
imageembeddings_embeddings_request_instance = ImageembeddingsEmbeddingsRequest.from_json(json)
# print the JSON string representation of the object
print(ImageembeddingsEmbeddingsRequest.to_json())

# convert the object into a dict
imageembeddings_embeddings_request_dict = imageembeddings_embeddings_request_instance.to_dict()
# create an instance of ImageembeddingsEmbeddingsRequest from a dict
imageembeddings_embeddings_request_form_dict = imageembeddings_embeddings_request.from_dict(imageembeddings_embeddings_request_dict)
```
