...
imagesearchdelete_image_delete_image_request_instance = ImagesearchdeleteImageDeleteImageRequest.from_json(json)
# print the JSON string representation of the object
print(ImagesearchdeleteImageDeleteImageRequest.to_json())

# convert the object into a dict
imagesearchdelete_image_delete_image_request_dict = imagesearchdelete_image_delete_image_request_instance.to_dict()
# create an instance of ImagesearchdeleteImageDeleteImageRequest from a dict
imagesearchdelete_image_delete_image_request_form_dict = imagesearchdelete_image_delete_image_request.from_dict(imagesearchdelete_image_delete_image_request_dict)
```
