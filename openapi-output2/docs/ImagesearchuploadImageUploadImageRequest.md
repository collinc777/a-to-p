...
**image_name** | **str** | The image name need to have the extension of the file. | 
...
json = "{}"
# create an instance of ImagesearchuploadImageUploadImageRequest from a JSON string
imagesearchupload_image_upload_image_request_instance = ImagesearchuploadImageUploadImageRequest.from_json(json)
# print the JSON string representation of the object
print(ImagesearchuploadImageUploadImageRequest.to_json())

# convert the object into a dict
imagesearchupload_image_upload_image_request_dict = imagesearchupload_image_upload_image_request_instance.to_dict()
# create an instance of ImagesearchuploadImageUploadImageRequest from a dict
imagesearchupload_image_upload_image_request_form_dict = imagesearchupload_image_upload_image_request.from_dict(imagesearchupload_image_upload_image_request_dict)
```
