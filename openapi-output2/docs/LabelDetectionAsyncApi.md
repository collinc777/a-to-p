...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection Launch Job
        api_response = api_instance.video_video_label_detection_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection delete Jobs
        api_instance.video_video_label_detection_async_destroy()
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection List Jobs
        api_response = api_instance.video_video_label_detection_async_retrieve()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Label Detection Get Job Results
        api_response = api_instance.video_video_label_detection_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
