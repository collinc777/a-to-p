...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking Launch Job
        api_response = api_instance.video_video_object_tracking_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking delete Jobs
        api_instance.video_video_object_tracking_async_destroy()
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking List Jobs
        api_response = api_instance.video_video_object_tracking_async_retrieve()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Video Object Tracking Get Job Results
        api_response = api_instance.video_video_object_tracking_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
