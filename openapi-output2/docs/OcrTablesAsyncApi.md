...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # OCR Tables Launch Job
        api_response = api_instance.ocr_ocr_ocr_tables_async_create(providers, fallback_providers=fallback_providers, show_original_response=show_original_response, webhook_receiver=webhook_receiver, users_webhook_parameters=users_webhook_parameters, file=file, file_url=file_url, file_password=file_password, language=language)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # OCR Tables delete Jobs
        api_instance.ocr_ocr_ocr_tables_async_destroy()
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # OCR Tables List Job
        api_response = api_instance.ocr_ocr_ocr_tables_async_retrieve()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # OCR Tables Get Job Results
        api_response = api_instance.ocr_ocr_ocr_tables_async_retrieve2(public_id, response_as_dict=response_as_dict, show_original_response=show_original_response)
