...
json = "{}"
# create an instance of OcrbankCheckParsingBankCheckParsingRequest from a JSON string
ocrbank_check_parsing_bank_check_parsing_request_instance = OcrbankCheckParsingBankCheckParsingRequest.from_json(json)
# print the JSON string representation of the object
print(OcrbankCheckParsingBankCheckParsingRequest.to_json())

# convert the object into a dict
ocrbank_check_parsing_bank_check_parsing_request_dict = ocrbank_check_parsing_bank_check_parsing_request_instance.to_dict()
# create an instance of OcrbankCheckParsingBankCheckParsingRequest from a dict
ocrbank_check_parsing_bank_check_parsing_request_form_dict = ocrbank_check_parsing_bank_check_parsing_request.from_dict(ocrbank_check_parsing_bank_check_parsing_request_dict)
```
