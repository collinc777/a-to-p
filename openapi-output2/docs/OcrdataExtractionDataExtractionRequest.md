...
json = "{}"
# create an instance of OcrdataExtractionDataExtractionRequest from a JSON string
ocrdata_extraction_data_extraction_request_instance = OcrdataExtractionDataExtractionRequest.from_json(json)
# print the JSON string representation of the object
print(OcrdataExtractionDataExtractionRequest.to_json())

# convert the object into a dict
ocrdata_extraction_data_extraction_request_dict = ocrdata_extraction_data_extraction_request_instance.to_dict()
# create an instance of OcrdataExtractionDataExtractionRequest from a dict
ocrdata_extraction_data_extraction_request_form_dict = ocrdata_extraction_data_extraction_request.from_dict(ocrdata_extraction_data_extraction_request_dict)
```
