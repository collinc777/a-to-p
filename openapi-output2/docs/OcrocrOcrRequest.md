...
json = "{}"
# create an instance of OcrocrOcrRequest from a JSON string
ocrocr_ocr_request_instance = OcrocrOcrRequest.from_json(json)
# print the JSON string representation of the object
print(OcrocrOcrRequest.to_json())

# convert the object into a dict
ocrocr_ocr_request_dict = ocrocr_ocr_request_instance.to_dict()
# create an instance of OcrocrOcrRequest from a dict
ocrocr_ocr_request_form_dict = ocrocr_ocr_request.from_dict(ocrocr_ocr_request_dict)
```
