...
json = "{}"
# create an instance of OcrresumeParserResumeParserRequest from a JSON string
ocrresume_parser_resume_parser_request_instance = OcrresumeParserResumeParserRequest.from_json(json)
# print the JSON string representation of the object
print(OcrresumeParserResumeParserRequest.to_json())

# convert the object into a dict
ocrresume_parser_resume_parser_request_dict = ocrresume_parser_resume_parser_request_instance.to_dict()
# create an instance of OcrresumeParserResumeParserRequest from a dict
ocrresume_parser_resume_parser_request_form_dict = ocrresume_parser_resume_parser_request.from_dict(ocrresume_parser_resume_parser_request_dict)
```
