...
**examples** | **List[List[str]]** | List of text/label pairs (eg: [[&#39;I need help please wire me $1000 right now&#39;, &#39;spam&#39;],] | 
...
json = "{}"
# create an instance of TextcustomClassificationCustomClassificationRequest from a JSON string
textcustom_classification_custom_classification_request_instance = TextcustomClassificationCustomClassificationRequest.from_json(json)
# print the JSON string representation of the object
print(TextcustomClassificationCustomClassificationRequest.to_json())

# convert the object into a dict
textcustom_classification_custom_classification_request_dict = textcustom_classification_custom_classification_request_instance.to_dict()
# create an instance of TextcustomClassificationCustomClassificationRequest from a dict
textcustom_classification_custom_classification_request_form_dict = textcustom_classification_custom_classification_request.from_dict(textcustom_classification_custom_classification_request_dict)
```
