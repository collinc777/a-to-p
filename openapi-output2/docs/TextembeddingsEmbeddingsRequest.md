...
**texts** | **List[str]** | List of texts to transform into embeddings. | 
...
json = "{}"
# create an instance of TextembeddingsEmbeddingsRequest from a JSON string
textembeddings_embeddings_request_instance = TextembeddingsEmbeddingsRequest.from_json(json)
# print the JSON string representation of the object
print(TextembeddingsEmbeddingsRequest.to_json())

# convert the object into a dict
textembeddings_embeddings_request_dict = textembeddings_embeddings_request_instance.to_dict()
# create an instance of TextembeddingsEmbeddingsRequest from a dict
textembeddings_embeddings_request_form_dict = textembeddings_embeddings_request.from_dict(textembeddings_embeddings_request_dict)
```
