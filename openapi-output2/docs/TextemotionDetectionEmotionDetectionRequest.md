...
json = "{}"
# create an instance of TextemotionDetectionEmotionDetectionRequest from a JSON string
textemotion_detection_emotion_detection_request_instance = TextemotionDetectionEmotionDetectionRequest.from_json(json)
# print the JSON string representation of the object
print(TextemotionDetectionEmotionDetectionRequest.to_json())

# convert the object into a dict
textemotion_detection_emotion_detection_request_dict = textemotion_detection_emotion_detection_request_instance.to_dict()
# create an instance of TextemotionDetectionEmotionDetectionRequest from a dict
textemotion_detection_emotion_detection_request_form_dict = textemotion_detection_emotion_detection_request.from_dict(textemotion_detection_emotion_detection_request_dict)
```
