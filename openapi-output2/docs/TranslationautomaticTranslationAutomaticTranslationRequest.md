...
json = "{}"
# create an instance of TranslationautomaticTranslationAutomaticTranslationRequest from a JSON string
translationautomatic_translation_automatic_translation_request_instance = TranslationautomaticTranslationAutomaticTranslationRequest.from_json(json)
# print the JSON string representation of the object
print(TranslationautomaticTranslationAutomaticTranslationRequest.to_json())

# convert the object into a dict
translationautomatic_translation_automatic_translation_request_dict = translationautomatic_translation_automatic_translation_request_instance.to_dict()
# create an instance of TranslationautomaticTranslationAutomaticTranslationRequest from a dict
translationautomatic_translation_automatic_translation_request_form_dict = translationautomatic_translation_automatic_translation_request.from_dict(translationautomatic_translation_automatic_translation_request_dict)
```
