...
class AnonymizationApi:
    ...
    @validate_call
    def image_image_anonymization_create(
        self,
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request: ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest,
        ...
        :param imageanonymizationimagelandmark_detectionimageexplicit_content_image_request: (required)
        :type imageanonymizationimagelandmark_detectionimageexplicit_content_image_request: ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest
        ...
        _param = self._image_image_anonymization_create_serialize(
            imageanonymizationimagelandmark_detectionimageexplicit_content_image_request=imageanonymizationimagelandmark_detectionimageexplicit_content_image_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ImageanonymizationResponseModel",
            "400": "BadRequest",
            "500": "Error",
            "403": "Error",
    ...
    @validate_call
    def image_image_anonymization_create_with_http_info(
        self,
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request: ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ImageanonymizationResponseModel]:
        """Anonymization
    ...
    @validate_call
    def image_image_anonymization_create_without_preload_content(
        self,
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request: ImageanonymizationimagelandmarkDetectionimageexplicitContentImageRequest,
        _request_timeout: Union[
            None,
    ...
    def _image_image_anonymization_create_serialize(
        self,
        imageanonymizationimagelandmark_detectionimageexplicit_content_image_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if (
            ...
            _body_params = imageanonymizationimagelandmark_detectionimageexplicit_content_image_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/image/anonymization",
    ...
    @validate_call
    def text_text_anonymization_create(
        self,
        ...
        _param = self._text_text_anonymization_create_serialize(
            texttopic_extractiontextanonymizationtextmoderationtextnamed_entity_recognitiontextkeyword_extractiontextsyntax_analysistextsentiment_analysis_text_analysis_request=texttopic_extractiontextanonymizationtextmoderationtextnamed_entity_recognitiontextkeyword_extractiontextsyntax_analysistextsentiment_analysis_text_analysis_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "TextanonymizationResponseModel",
            "400": "BadRequest",
            "500": "Error",
            "403": "Error",
            "404": "NotFoundResponse",
    ...
    @validate_call
    def text_text_anonymization_create_with_http_info(
        self,
        texttopic_extractiontextanonymizationtextmoderationtextnamed_entity_recognitiontextkeyword_extractiontextsyntax_analysistextsentiment_analysis_text_analysis_request: TexttopicExtractiontextanonymizationtextmoderationtextnamedEntityRecognitiontextkeywordExtractiontextsyntaxAnalysistextsentimentAnalysisTextAnalysisRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TextanonymizationResponseModel]:
        """Anonymization
    ...
    @validate_call
    def text_text_anonymization_create_without_preload_content(
        self,
        texttopic_extractiontextanonymizationtextmoderationtextnamed_entity_recognitiontextkeyword_extractiontextsyntax_analysistextsentiment_analysis_text_analysis_request: TexttopicExtractiontextanonymizationtextmoderationtextnamedEntityRecognitiontextkeywordExtractiontextsyntaxAnalysistextsentimentAnalysisTextAnalysisRequest,
        _request_timeout: Union[
            None,
    ...
    def _text_text_anonymization_create_serialize(
        self,
        texttopic_extractiontextanonymizationtextmoderationtextnamed_entity_recognitiontextkeyword_extractiontextsyntax_analysistextsentiment_analysis_text_analysis_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/text/anonymization",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
