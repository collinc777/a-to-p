...
class BatchApi:
    ...
    @validate_call
    def batch_batch_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def batch_batch_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def feature_batch_create_with_http_info(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
    ...
    @validate_call
    def feature_batch_create_without_preload_content(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
    ...
    @validate_call
    def feature_batch_destroy_with_http_info(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
    ...
    @validate_call
    def feature_batch_destroy_without_preload_content(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
    ...
    def feature_batch_retrieve(
        ...
        status: Annotated[
            ...
            Field(
                description="* `succeeded` - Status Succeeded * `failed` - Status Failed * `finished` - Status Finished * `processing` - Status Processing"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def feature_batch_retrieve_with_http_info(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
    ...
    @validate_call
    def feature_batch_retrieve_without_preload_content(
        self,
        feature: StrictStr,
        name: StrictStr,
        subfeature: StrictStr,
