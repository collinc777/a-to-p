...
class FaceDetectionAsyncApi:
    ...
    @validate_call
    def video_video_face_detection_async_create(
        self,
        providers: Annotated[
            str,
            Field(
        ...
        _param = self._video_video_face_detection_async_create_serialize(
            providers=providers,
    ...
    @validate_call
    def video_video_face_detection_async_create_with_http_info(
        self,
        providers: Annotated[
            str,
            Field(
    ...
    @validate_call
    def video_video_face_detection_async_create_without_preload_content(
        self,
        providers: Annotated[
            str,
            Field(
    ...
    def _video_video_face_detection_async_create_serialize(
        self,
        providers,
        fallback_providers,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/video/face_detection_async",
    ...
    @validate_call
    def video_video_face_detection_async_destroy(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._video_video_face_detection_async_destroy_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def video_video_face_detection_async_destroy_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def video_video_face_detection_async_destroy_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _video_video_face_detection_async_destroy_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def video_video_face_detection_async_retrieve(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._video_video_face_detection_async_retrieve_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def video_video_face_detection_async_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def video_video_face_detection_async_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _video_video_face_detection_async_retrieve_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def video_video_face_detection_async_retrieve2(
        self,
        public_id: StrictStr,
        ...
        _param = self._video_video_face_detection_async_retrieve2_serialize(
            public_id=public_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "AsyncvideofaceDetectionAsyncResponseModel",
            "400": "BadRequest",
            "500": "Error",
            "403": "Error",
    ...
    @validate_call
    def video_video_face_detection_async_retrieve2_with_http_info(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AsyncvideofaceDetectionAsyncResponseModel]:
        """Face Detection Get Job Results
    ...
    @validate_call
    def video_video_face_detection_async_retrieve2_without_preload_content(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
    ...
    def _video_video_face_detection_async_retrieve2_serialize(
        self,
        public_id,
        response_as_dict,
        show_original_response,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/video/face_detection_async/{public_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
