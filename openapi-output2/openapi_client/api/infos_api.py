...
class InfosApi:
    ...
    @validate_call
    def info_info_provider_subfeatures_list(
        self,
        feature__name: Optional[StrictStr] = None,
        gender: Annotated[
            Optional[StrictStr],
            Field(
                description="Accepts two values: either 'male' or 'female'. Used to                              filter models voices for the text_to_speech subfeature"
            ),
        ] = None,
        is_working: Optional[StrictBool] = None,
        language: Annotated[
            Optional[StrictStr], Field(description="languages [icontains]")
        ] = None,
    ...
    @validate_call
    def info_info_provider_subfeatures_list_with_http_info(
        self,
        feature__name: Optional[StrictStr] = None,
        gender: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def info_info_provider_subfeatures_list_without_preload_content(
        self,
        feature__name: Optional[StrictStr] = None,
        gender: Annotated[
            Optional[StrictStr],
