...
class OcrAsyncApi:
    ...
    @validate_call
    def ocr_ocr_ocr_async_create_with_http_info(
        self,
        providers: Annotated[
            str,
            Field(
    ...
    @validate_call
    def ocr_ocr_ocr_async_create_without_preload_content(
        self,
        providers: Annotated[
            str,
            Field(
    ...
    @validate_call
    def ocr_ocr_ocr_async_destroy_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ocr_ocr_ocr_async_destroy_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve2(
        self,
        public_id: StrictStr,
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve2_with_http_info(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
    ...
    @validate_call
    def ocr_ocr_ocr_async_retrieve2_without_preload_content(
        self,
        public_id: StrictStr,
        response_as_dict: Optional[StrictBool] = None,
        show_original_response: Optional[StrictBool] = None,
