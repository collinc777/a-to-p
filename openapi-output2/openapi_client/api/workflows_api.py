...
class WorkflowsApi:
    ...
    @validate_call
    def pipeline_pipeline_create(
        self,
        description: Annotated[str, Field(min_length=1, strict=True)],
        text: Annotated[
            Optional[Annotated[str, Field(min_length=1, strict=True)]],
            Field(description="The input text for the first feature of the pipeline"),
        ] = None,
        texts: Annotated[
            Optional[Annotated[str, Field(min_length=1, strict=True)]],
            Field(description="List of texts for the first feature of the pipeline"),
        ] = None,
        file: Annotated[
            Optional[Union[StrictBytes, StrictStr]],
            Field(description="The input file for the first feature of the pipeline"),
        ] = None,
        return_only_last: Annotated[
            Optional[StrictBool],
            Field(
    ...
    @validate_call
    def pipeline_pipeline_create_with_http_info(
        self,
        description: Annotated[str, Field(min_length=1, strict=True)],
        text: Annotated[
            Optional[Annotated[str, Field(min_length=1, strict=True)]],
    ...
    @validate_call
    def pipeline_pipeline_create_without_preload_content(
        self,
        description: Annotated[str, Field(min_length=1, strict=True)],
        text: Annotated[
            Optional[Annotated[str, Field(min_length=1, strict=True)]],
