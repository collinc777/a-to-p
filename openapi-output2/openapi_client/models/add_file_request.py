...
class AddFileRequest(BaseModel):
    ...
    metadata: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None,
    ...
    provider: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None,
    ...
    def file_validate_regular_expression(cls, value):
        ...
        if not re.match(r"(?:pdf|csv|amr|flac|wav|ogg|mp3|mp4|webm)$", value):
            raise ValueError(
                r"must validate the regular expression /(?:pdf|csv|amr|flac|wav|ogg|mp3|mp4|webm)$/"
            )
        return value
