...
class AsyncocrcustomDocumentParsingAsyncResponseModel(BaseModel):
    """
    ...
    public_id: StrictStr
    status: StrictStr
    __properties: ClassVar[List[str]] = ["results", "error", "public_id", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "results": OcrcustomDocumentParsingAsyncModel.from_dict(obj["results"])
