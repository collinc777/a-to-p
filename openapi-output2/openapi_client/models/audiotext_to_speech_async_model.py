...
class AudiotextToSpeechAsyncModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "lovoai": PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364509152.from_dict(
                    obj["lovoai"]
                )
                if obj.get("lovoai") is not None
                else None,
                "amazon": PydanticMainAudiotextToSpeechAsyncTextToSpeechAsyncDataClass94559364747360.from_dict(
                    obj["amazon"]
                )
