...
class BatchLaunchResponse(BaseModel):
    ...
    failed_requests: List[BatchLaunchFailedRequest] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "total": obj.get("total"),
                "failed_requests": [
                    BatchLaunchFailedRequest.from_dict(_item)
                    for _item in obj["failed_requests"]
                ]
                if obj.get("failed_requests") is not None
                else None,
            }
        )
        return _obj
