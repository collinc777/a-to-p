...
class EmotionItem(BaseModel):
    ...
    emotion: StrictStr
    emotion_score: Annotated[int, Field(le=100, strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["emotion", "emotion_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"emotion": obj.get("emotion"), "emotion_score": obj.get("emotion_score")}
        )
        return _obj
