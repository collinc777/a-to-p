        ...
        _obj = cls.model_validate(
            {
                ...
                "landmarks": FaceLandmarks.from_dict(obj["landmarks"])
                if obj.get("landmarks") is not None
                else None,
                "emotions": FaceEmotions.from_dict(obj["emotions"])
                if obj.get("emotions") is not None
                else None,
                "poses": FacePoses.from_dict(obj["poses"])
                if obj.get("poses") is not None
                else None,
                "age": obj.get("age"),
                "gender": obj.get("gender"),
                "bounding_box": FaceBoundingBox.from_dict(obj["bounding_box"])
                if obj.get("bounding_box") is not None
                else None,
                "hair": FaceHair.from_dict(obj["hair"])
                if obj.get("hair") is not None
                else None,
                "facial_hair": FaceFacialHair.from_dict(obj["facial_hair"])
                if obj.get("facial_hair") is not None
                else None,
                "quality": FaceQuality.from_dict(obj["quality"])
                if obj.get("quality") is not None
                else None,
                "makeup": FaceMakeup.from_dict(obj["makeup"])
                if obj.get("makeup") is not None
                else None,
                "accessories": FaceAccessories.from_dict(obj["accessories"])
                if obj.get("accessories") is not None
                else None,
                "occlusions": FaceOcclusions.from_dict(obj["occlusions"])
                if obj.get("occlusions") is not None
                else None,
                "features": FaceFeatures.from_dict(obj["features"])
