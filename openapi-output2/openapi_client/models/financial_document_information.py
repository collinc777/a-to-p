...
class FinancialDocumentInformation(BaseModel):
    ...
    barcodes: Optional[List[FinancialBarcode]] = Field(
        default=None, description="List of barcodes associated with the document."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "barcodes": [
                    FinancialBarcode.from_dict(_item) for _item in obj["barcodes"]
                ]
