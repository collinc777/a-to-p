...
class FinancialLineItem(BaseModel):
    ...
    tax: Optional[StrictInt] = Field(
        default=None, description="Tax amount for the line item."
    )
    amount_line: Optional[StrictInt] = Field(
    ...
    unit_price: Optional[StrictInt] = Field(
    ...
    var_date: Optional[StrictStr] = Field(
        default=None, description="Date associated with the line item.", alias="date"
    )
    ...
    discount_rate: Optional[StrictInt] = Field(
