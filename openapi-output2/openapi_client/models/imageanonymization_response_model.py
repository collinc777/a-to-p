...
class ImageanonymizationResponseModel(BaseModel):
    """
    ImageanonymizationResponseModel
    """  # noqa: E501

    api4ai: Optional[ImageanonymizationAnonymizationDataClass] = None
    __properties: ClassVar[List[str]] = ["api4ai"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "api4ai": ImageanonymizationAnonymizationDataClass.from_dict(
                    obj["api4ai"]
                )
