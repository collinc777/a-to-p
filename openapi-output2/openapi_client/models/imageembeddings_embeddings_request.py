...
class ImageembeddingsEmbeddingsRequest(BaseModel):
    """
    ...
    representation: RepresentationEnum = Field(
        description="The type of embedding representation to embed the image with  * `document` - document * `query` - query * `symetric` - symetric"
    )
