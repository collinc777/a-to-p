...
class ImageembeddingsResponseModel(BaseModel):
    """
    ImageembeddingsResponseModel
    """  # noqa: E501

    alephalpha: Optional[ImageembeddingsEmbeddingsDataClass] = None
    __properties: ClassVar[List[str]] = ["alephalpha"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "alephalpha": ImageembeddingsEmbeddingsDataClass.from_dict(
                    obj["alephalpha"]
                )
