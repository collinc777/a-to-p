...
class ImagequestionAnswerQuestionAnswerRequest(BaseModel):
    ...
    question: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="Question about the image"
    )
    max_tokens: Optional[Annotated[int, Field(le=2048, strict=True, ge=1)]] = Field(
        default=1000,
