...
class ImagequestionAnswerResponseModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "openai": PydanticMainImagequestionAnswerQuestionAnswerDataClass94559363729920.from_dict(
                    obj["openai"]
                )
                if obj.get("openai") is not None
                else None,
                "alephalpha": PydanticMainImagequestionAnswerQuestionAnswerDataClass94559363731456.from_dict(
                    obj["alephalpha"]
                )
                if obj.get("alephalpha") is not None
                else None,
                "google": PydanticMainImagequestionAnswerQuestionAnswerDataClass94559363736752.from_dict(
                    obj["google"]
                )
