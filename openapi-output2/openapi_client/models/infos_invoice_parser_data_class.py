...
class InfosInvoiceParserDataClass(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "customer_information": CustomerInformationInvoice.from_dict(
                    obj["customer_information"]
                )
                if obj.get("customer_information") is not None
                else None,
                "merchant_information": MerchantInformationInvoice.from_dict(
                ...
                "taxes": [TaxesInvoice.from_dict(_item) for _item in obj["taxes"]]
                ...
                "locale": LocaleInvoice.from_dict(obj["locale"])
                if obj.get("locale") is not None
                else None,
                "bank_informations": BankInvoice.from_dict(obj["bank_informations"])
                if obj.get("bank_informations") is not None
                else None,
                "item_lines": [
                    ItemLinesInvoice.from_dict(_item) for _item in obj["item_lines"]
                ]
