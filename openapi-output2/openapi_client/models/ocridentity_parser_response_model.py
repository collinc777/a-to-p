...
class OcridentityParserResponseModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "klippa": PydanticMainOcridentityParserIdentityParserDataClass94559367734784.from_dict(
                    obj["klippa"]
                )
                if obj.get("klippa") is not None
                else None,
                "mindee": PydanticMainOcridentityParserIdentityParserDataClass94559367730672.from_dict(
                    obj["mindee"]
                )
                if obj.get("mindee") is not None
                else None,
                "affinda": PydanticMainOcridentityParserIdentityParserDataClass94559364172000.from_dict(
                    obj["affinda"]
                )
                if obj.get("affinda") is not None
                else None,
                "microsoft": PydanticMainOcridentityParserIdentityParserDataClass94559367743664.from_dict(
                    obj["microsoft"]
                )
                if obj.get("microsoft") is not None
                else None,
                "amazon": PydanticMainOcridentityParserIdentityParserDataClass94559367750928.from_dict(
                    obj["amazon"]
                )
                if obj.get("amazon") is not None
                else None,
                "base64": PydanticMainOcridentityParserIdentityParserDataClass94559367757600.from_dict(
                    obj["base64"]
                )
                if obj.get("base64") is not None
                else None,
                "eden-ai": PydanticMainOcridentityParserIdentityParserDataClass94559367824608.from_dict(
                    obj["eden-ai"]
                )
