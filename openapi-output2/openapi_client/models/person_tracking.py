        ...
        _obj = cls.model_validate(
            {
                ...
                "attributes": PersonAttributes.from_dict(obj["attributes"])
                if obj.get("attributes") is not None
                else None,
                "landmarks": PersonLandmarks.from_dict(obj["landmarks"])
                if obj.get("landmarks") is not None
                else None,
                "poses": VideoPersonPoses.from_dict(obj["poses"])
                if obj.get("poses") is not None
                else None,
                "quality": VideoPersonQuality.from_dict(obj["quality"])
                if obj.get("quality") is not None
                else None,
                "bounding_box": VideoTrackingBoundingBox.from_dict(obj["bounding_box"])
