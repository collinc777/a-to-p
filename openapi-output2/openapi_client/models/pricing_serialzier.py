...
class PricingSerialzier(BaseModel):
    ...
    def price_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^-?\d{0,6}(?:\.\d{0,9})?$", value):
            raise ValueError(
                r"must validate the regular expression /^-?\d{0,6}(?:\.\d{0,9})?$/"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            self.min_price_quantity is None
            and "min_price_quantity" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "detail_type": PricingSerialzierDetailType.from_dict(obj["detail_type"])
                if obj.get("detail_type") is not None
                else None,
