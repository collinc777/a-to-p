...
class ProviderSubfeature(BaseModel):
    ...
    description_title: Optional[Annotated[str, Field(strict=True, max_length=100)]] = (
        None
    )
    description_content: Optional[
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if (
            self.description_title is None
            and "description_title" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.description_content is None
            and "description_content" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "pricings": [
                    PricingSerialzier.from_dict(_item) for _item in obj["pricings"]
                ]
                if obj.get("pricings") is not None
                else None,
                "is_working": obj.get("is_working"),
                "description_title": obj.get("description_title"),
                "description_content": obj.get("description_content"),
                "provider": Provider.from_dict(obj["provider"])
                if obj.get("provider") is not None
                else None,
                "feature": Feature.from_dict(obj["feature"])
                if obj.get("feature") is not None
                else None,
                "subfeature": Subfeature.from_dict(obj["subfeature"])
                if obj.get("subfeature") is not None
                else None,
                "constraints": obj.get("constraints"),
                "models": obj.get("models"),
                "languages": [
                    ProviderSubfeatureLanguagesInner.from_dict(_item)
                    for _item in obj["languages"]
                ]
