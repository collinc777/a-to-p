...
class PydanticMainOcrfinancialParserFinancialParserDataClass94559368046576(BaseModel):
    """
    PydanticMainOcrfinancialParserFinancialParserDataClass94559368046576
    """  # noqa: E501

    extracted_data: Optional[List[FinancialParserObjectDataClass]] = Field(
        default=None, description="List of parsed financial data objects (per page)."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "extracted_data": [
                    FinancialParserObjectDataClass.from_dict(_item)
                    for _item in obj["extracted_data"]
                ]
                if obj.get("extracted_data") is not None
                else None,
