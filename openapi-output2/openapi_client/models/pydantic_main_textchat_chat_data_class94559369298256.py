...
class PydanticMainTextchatChatDataClass94559369298256(BaseModel):
    """
    PydanticMainTextchatChatDataClass94559369298256
    """  # noqa: E501

    generated_text: StrictStr
    message: Optional[List[ChatMessageDataClass]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "message": [
                    ChatMessageDataClass.from_dict(_item) for _item in obj["message"]
                ]
