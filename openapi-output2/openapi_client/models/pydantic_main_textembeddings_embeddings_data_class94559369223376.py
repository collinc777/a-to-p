...
class PydanticMainTextembeddingsEmbeddingsDataClass94559369223376(BaseModel):
    """
    PydanticMainTextembeddingsEmbeddingsDataClass94559369223376
    """  # noqa: E501

    items: Optional[List[EmbeddingDataClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": [EmbeddingDataClass.from_dict(_item) for _item in obj["items"]]
