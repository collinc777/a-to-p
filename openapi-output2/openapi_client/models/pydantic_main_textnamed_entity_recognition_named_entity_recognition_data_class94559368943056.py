...
class PydanticMainTextnamedEntityRecognitionNamedEntityRecognitionDataClass94559368943056(
    BaseModel
):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PydanticMainTextnamedEntityRecognitionNamedEntityRecognitionDataClass94559368943056 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PydanticMainTextnamedEntityRecognitionNamedEntityRecognitionDataClass94559368943056 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "items": [
                    InfosNamedEntityRecognitionDataClass.from_dict(_item)
