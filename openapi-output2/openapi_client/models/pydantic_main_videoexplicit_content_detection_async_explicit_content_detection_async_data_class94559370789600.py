...
class PydanticMainVideoexplicitContentDetectionAsyncExplicitContentDetectionAsyncDataClass94559370789600(
    BaseModel
):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "moderation": [
                    ContentNSFW.from_dict(_item) for _item in obj["moderation"]
                ]
                if obj.get("moderation") is not None
                else None,
