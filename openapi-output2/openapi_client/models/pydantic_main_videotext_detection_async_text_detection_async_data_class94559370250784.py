...
class PydanticMainVideotextDetectionAsyncTextDetectionAsyncDataClass94559370250784(
    BaseModel
):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "texts": [VideoText.from_dict(_item) for _item in obj["texts"]]
                if obj.get("texts") is not None
                else None,
