...
class Subcategory(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, FinancialInformationSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `FinancialInformationSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, PersonalInformationSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `PersonalInformationSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, IdentificationNumbersSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `IdentificationNumbersSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, MiscellaneousSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `MiscellaneousSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, OrganizationSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `OrganizationSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, DateAndTimeSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DateAndTimeSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, LocationInformationSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `LocationInformationSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, OtherSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `OtherSubCategoryType`"
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[FinancialInformationSubCategoryType] = None
        try:
            instance.actual_instance = FinancialInformationSubCategoryType.from_json(
                json_str
            )
            return instance
        ...
        # anyof_schema_2_validator: Optional[PersonalInformationSubCategoryType] = None
        try:
            instance.actual_instance = PersonalInformationSubCategoryType.from_json(
                json_str
            )
            return instance
        except (ValidationError, ValueError) as e:
        ...
        # anyof_schema_3_validator: Optional[IdentificationNumbersSubCategoryType] = None
        try:
            instance.actual_instance = IdentificationNumbersSubCategoryType.from_json(
                json_str
            )
            return instance
        except (ValidationError, ValueError) as e:
        ...
        # anyof_schema_7_validator: Optional[LocationInformationSubCategoryType] = None
        try:
            instance.actual_instance = LocationInformationSubCategoryType.from_json(
                json_str
            )
            return instance
        except (ValidationError, ValueError) as e:
