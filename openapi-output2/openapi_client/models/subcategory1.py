...
class Subcategory1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, ToxicSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ToxicSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, ContentSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ContentSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, SexualSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SexualSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, ViolenceSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `ViolenceSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, DrugAndAlcoholSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `DrugAndAlcoholSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, FinanceSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `FinanceSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, HateAndExtremismSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `HateAndExtremismSubCategoryType`"
            )
        else:
            return v
        ...
        if not isinstance(v, SafeSubCategoryType):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `SafeSubCategoryType`"
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_7_validator: Optional[HateAndExtremismSubCategoryType] = None
        try:
            instance.actual_instance = HateAndExtremismSubCategoryType.from_json(
                json_str
            )
            return instance
        except (ValidationError, ValueError) as e:
