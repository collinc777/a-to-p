...
class TextchatChatRequest(BaseModel):
    ...
    text: Optional[StrictStr] = Field(
        default="", description="Start your conversation here..."
    )
    chatbot_global_action: Optional[StrictStr] = Field(
        default="",
        description="A system message that helps set the behavior of the assistant. For example, 'You are a helpful assistant'.",
    )
    previous_history: Optional[List[Dict[str, Any]]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.chatbot_global_action is None
            and "chatbot_global_action" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("chatbot_global_action") is not None
                else "",
