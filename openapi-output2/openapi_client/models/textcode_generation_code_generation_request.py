...
class TextcodeGenerationCodeGenerationRequest(BaseModel):
    ...
    prompt: Optional[StrictStr] = Field(
        default="", description="Entrer the source code that will be used as a context."
    )
    instruction: Annotated[str, Field(min_length=1, strict=True)] = Field(
    ...
    max_tokens: Optional[Annotated[int, Field(le=4096, strict=True, ge=1)]] = Field(
        default=1000,
