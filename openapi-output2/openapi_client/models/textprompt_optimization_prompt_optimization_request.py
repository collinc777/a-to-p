...
class TextpromptOptimizationPromptOptimizationRequest(BaseModel):
    """
    ...
    target_provider: TargetProviderEnum = Field(
        description="Select the provider for the prompt optimization  * `google` - google * `openai` - openai * `cohere` - cohere"
    )
