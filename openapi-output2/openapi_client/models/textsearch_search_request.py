...
class TextsearchSearchRequest(BaseModel):
    ...
    response_as_dict: Optional[StrictBool] = Field(
        default=True,
    ...
    attributes_as_list: Optional[StrictBool] = Field(
        default=False,
    ...
    texts: Annotated[
        List[Annotated[str, Field(min_length=1, strict=True)]], Field(min_length=2)
    ] = Field(description="A list of texts to search in.")
    query: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="Your text query."
    )
    similarity_metric: Optional[SimilarityMetricEnum] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "response_as_dict": obj.get("response_as_dict")
                if obj.get("response_as_dict") is not None
                else True,
                "attributes_as_list": obj.get("attributes_as_list")
                if obj.get("attributes_as_list") is not None
                else False,
