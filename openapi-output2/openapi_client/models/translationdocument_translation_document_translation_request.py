...
class TranslationdocumentTranslationDocumentTranslationRequest(BaseModel):
    ...
    source_language: Optional[StrictStr] = Field(
        default=None, description="Source language code (ex: en, fr)"
    )
    target_language: Annotated[str, Field(min_length=1, strict=True)] = Field(
