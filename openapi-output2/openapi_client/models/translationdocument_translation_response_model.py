...
class TranslationdocumentTranslationResponseModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "google": PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370176816.from_dict(
                    obj["google"]
                )
                if obj.get("google") is not None
                else None,
                "deepl": PydanticMainTranslationdocumentTranslationDocumentTranslationDataClass94559370115408.from_dict(
                    obj["deepl"]
                )
