...
class UniversalTranslatorCreatet(BaseModel):
    ...
    source_language: Optional[Annotated[str, Field(strict=True, max_length=10)]] = (
        Field(
            default=None,
            description="The language code from which the text will be translated",
        )
    )
    target_language: Optional[Annotated[str, Field(strict=True, max_length=10)]] = (
        Field(
            default=None,
    ...
    fall_back_providers: Optional[
        List[Annotated[str, Field(strict=True, max_length=30)]]
    ] = None
