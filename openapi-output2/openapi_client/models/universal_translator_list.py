...
class UniversalTranslatorList(BaseModel):
    ...
    target_language: Optional[StrictStr] = Field(
    ...
    fall_back_providers: Optional[StrictStr] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.fall_back_providers is None
            and "fall_back_providers" in self.model_fields_set
        ):
