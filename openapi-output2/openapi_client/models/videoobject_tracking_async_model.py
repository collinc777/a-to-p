...
class VideoobjectTrackingAsyncModel(BaseModel):
    """
    VideoobjectTrackingAsyncModel
    """  # noqa: E501

    google: Optional[VideoobjectTrackingAsyncObjectTrackingAsyncDataClass] = None
    __properties: ClassVar[List[str]] = ["google"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "google": VideoobjectTrackingAsyncObjectTrackingAsyncDataClass.from_dict(
                    obj["google"]
                )
