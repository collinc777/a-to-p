...
class VideopersonTrackingAsyncModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "amazon": PydanticMainVideopersonTrackingAsyncPersonTrackingAsyncDataClass94559370356272.from_dict(
                    obj["amazon"]
                )
                if obj.get("amazon") is not None
                else None,
                "google": PydanticMainVideopersonTrackingAsyncPersonTrackingAsyncDataClass94559370474160.from_dict(
                    obj["google"]
                )
