...
class YodaQueryResponsePayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["metadata", "page_content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"metadata": obj.get("metadata"), "page_content": obj.get("page_content")}
        )
        return _obj
