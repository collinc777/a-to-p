...
class TestFinancialParserObjectDataClass(unittest.TestCase):
    """FinancialParserObjectDataClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FinancialParserObjectDataClass:
        """Test FinancialParserObjectDataClass
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FinancialParserObjectDataClass`
        """
        model = FinancialParserObjectDataClass()
        if include_optional:
            return FinancialParserObjectDataClass(
    ...
    def testFinancialParserObjectDataClass(self):
        """Test FinancialParserObjectDataClass"""
